...
const u8 main_pal0[16] = { 0x54, 0x44, 0x5c, 0x58, 0x45, 0x52, 0x46, 0x5e, 0x40, 0x47, 0x42, 0x53, 0x5a, 0x4a, 0x43, 0x4b };

// Tile sp_suelo: 100x8 pixels, 50x8 bytes.
const u8 sp_suelo[50 * 8] = {
