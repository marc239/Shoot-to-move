...
Hexadecimal [16-Bits]
                             ...
                             21 
                             22 .module sys_entity_physics
                             23 
                             24 ;;PHYSICS SYSTEM
                             25 
                             26 ;;Constantes
                     0050    27 screen_width = 80
                     00C8    28 screen_height = 200
                             29 
   7BBB 00                   30 x_antigua: .db 0x00
                             31 
   7BBC                      32 sys_physics_init::
   7BBC C9            [10]   33 	ret
                             34 
                             35 
                             36 ;;SYS_PHYSICS::UPDATE
                             37 ;; INPUT:
                             38 ;; IX: Puntero al array de entidades
                             39 ;; A: Elementos en el array
                             40 
   7BBD                      41 sys_physics_update::
                             42 
   7BBD 47            [ 4]   43 	ld b, a ;; B = numero de entidades
                             44 
   7BBE                      45 _update_loop:
                             46 
   7BBE 3E 51         [ 7]   47 	ld a, #screen_width + 1   ;;tenemos en cuenta el ancho para los limites
   7BC0 DD 96 04      [19]   48 	sub e_w(ix)
   7BC3 4F            [ 4]   49 	ld c, a
                             50 
   7BC4 DD 7E 00      [19]   51 	ld a, e_x(ix)
   7BC7 DD 86 02      [19]   52 	add e_vx(ix)
   7BCA B9            [ 4]   53 	cp c
   7BCB 30 05         [12]   54 	jr nc, invalid_x ;;comprueba que la posicion es correcta
                             55 	;;DE MOMENTO COMPROBAMOS TODAS LAS COLISIONES
   7BCD                      56 valid_x:
   7BCD DD 77 00      [19]   57 		ld e_x(ix), a
   7BD0 18 14         [12]   58 		jr endif_x
   7BD2                      59 invalid_x:	
                             60 		;;ld a, e_vx(ix)
                             61 		;;COMPROBAMOS SI es una bala
   7BD2 DD 7E 0A      [19]   62 		ld a, e_bal(ix)
   7BD5 FE 00         [ 7]   63 		cp #0
   7BD7 28 0D         [12]   64 		jr z, endif_x ;;si no es bala seguimos
                             65 		;;SI ES UNA BALA LA DESTRUIMOS
   7BD9 C5            [11]   66 		push bc
   7BDA D5            [11]   67 		push de
   0020                      68 		ld__d_ixh
   7BDB DD 54                 1    .dw #0x54DD  ;; Opcode for ld d, ixh
   0022                      69 		ld__e_ixl
   7BDD DD 5D                 1    .dw #0x5DDD  ;; Opcode for ld e, ixl
   7BDF 62            [ 4]   70 		ld h, d
   7BE0 6B            [ 4]   71 		ld l, e
   7BE1 CD 03 8E      [17]   72 		call man_entity_delete
   7BE4 D1            [10]   73 		pop de
ASxxxx Assembler V02.00 + NoICE + SDCC mods  (Zilog Z80 / Hitachi HD64180), page 58.
Hexadecimal [16-Bits]



   7BE5 C1            [10]   74 		pop bc
   7BE6                      75 endif_x:
                             76 
   7BE6 3E C9         [ 7]   77 	ld a, #screen_height + 1   ;;tenemos en cuenta el ancho para los limites
   7BE8 DD 96 05      [19]   78 	sub e_h(ix)
   7BEB 4F            [ 4]   79 	ld c, a
                             80 
   7BEC DD 7E 01      [19]   81 	ld a, e_y(ix)
   7BEF DD 86 03      [19]   82 	add e_vy(ix)
   7BF2 B9            [ 4]   83 	cp c
   7BF3 30 05         [12]   84 	jr nc, invalid_y ;;comprueba que la posicion es correcta
   7BF5                      85 valid_y:
   7BF5 DD 77 01      [19]   86 		ld e_y(ix), a
   7BF8 18 14         [12]   87 		jr endif_y
   7BFA                      88 invalid_y:	
                             89 		;ld a, e_vy(ix)
                             90 		;neg
                             91 		;ld e_vy(ix), a ;; no te mueves
                             92 		
   7BFA DD 7E 0A      [19]   93 		ld a, e_bal(ix)
   7BFD FE 00         [ 7]   94 		cp #0
   7BFF 28 0D         [12]   95 		jr z, endif_y ;;si no es bala seguimos
                             96 		;;SI ES UNA BALA LA DESTRUIMOS
   7C01 C5            [11]   97 		push bc
   7C02 D5            [11]   98 		push de
   0048                      99 		ld__d_ixh
   7C03 DD 54                 1    .dw #0x54DD  ;; Opcode for ld d, ixh
   004A                     100 		ld__e_ixl
   7C05 DD 5D                 1    .dw #0x5DDD  ;; Opcode for ld e, ixl
   7C07 62            [ 4]  101 		ld h, d
   7C08 6B            [ 4]  102 		ld l, e
   7C09 CD 03 8E      [17]  103 		call man_entity_delete
   7C0C D1            [10]  104 		pop de
   7C0D C1            [10]  105 		pop bc
   7C0E                     106 endif_y:
                            107 
   7C0E 05            [ 4]  108 	dec b
   7C0F C8            [11]  109 	ret z             ;;si no hay entidades acabamos 
                            110 
   7C10 11 17 00      [10]  111 	ld de, #sizeof_e
   7C13 DD 19         [15]  112 	add ix, de
   7C15 18 A7         [12]  113 	jr _update_loop
