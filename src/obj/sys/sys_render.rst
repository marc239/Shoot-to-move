...
Hexadecimal [16-Bits]
                             ...
                             26 
                             27 
                             28 .module sys_entity_render
                             29 
                             30 
                             31 
                             32 
                             33 ;screen_start = 0xC000
                             34 
                             35 
                             36 
                             37 
   7AEA                      38 sys_eren_init::
                             39 
   7AEA 0E 00         [ 7]   40 	ld c, #0
   7AEC CD 89 98      [17]   41 	call cpct_setVideoMode_asm ;;pone el modo de video a cero
   7AEF 21 44 75      [10]   42 	ld hl, #_main_pal
   7AF2 11 10 00      [10]   43 	ld de, #16
   7AF5 CD 07 8F      [17]   44 	call cpct_setPalette_asm
                             45 	;cpctm_setBorder_asm HW_WHITE ;;cambio el color del borde
                             46 
                             47 	;;LIMPIAMOS LA MEMORIA DE VIDEO
   000E                      48 	cpctm_clearScreen_asm #00
   7AF8 21 00 C0      [10]    1    ld    hl, #0xC000    ;; [3] HL Points to Start of Video Memory
   7AFB 11 01 C0      [10]    2    ld    de, #0xC001    ;; [3] DE Points to the next byte
   7AFE 01 00 40      [10]    3    ld    bc, #0x4000    ;; [3] BC = 16384 bytes to be copied
   7B01 36 00         [10]    4    ld   (hl), ##00      ;; [3] First Byte = given Colour
   7B03 ED B0         [21]    5    ldir                 ;; [98297] Perform the copy
                             49 
                             50 	;ld de, #0xC000
                             51 	;ld a, #0xFF
                             52 	;ld c, #64 ;;ANCHURA
                             53 	;ld b, #200
                             54 	;call cpct_drawSolidBox_asm
                             55 
                             56 
   7B05 C9            [10]   57 	ret
                             58 
                             ...
                             61 ;;UPDATE
                             62 ;;INPUT:
                             63 ;;  IX = Puntero al array de entidades
                             64 ;; A = Numero de elementos en el array
                             65 
   7B06                      66 sys_eren_update::
                             67 
   7B06 CD 0A 7B      [17]   68 	call sys_eren_render_entities
                             69 
   7B09 C9            [10]   70 	ret
                             71 
                             72 
                             73 ;;RENDER ENTITIES
                             74 ;;INPUT:
                             75 ;;  IX = Puntero al array de entidades
ASxxxx Assembler V02.00 + NoICE + SDCC mods  (Zilog Z80 / Hitachi HD64180), page 61.
Hexadecimal [16-Bits]



                             76 ;; A = Numero de elementos en el array
   7B0A                      77 sys_eren_render_entities::
                             78 
   7B0A 32 5D 7B      [13]   79 	ld (_ent_counter), a ;;guardo el contador en una variable
                             80 
   7B0D                      81 _update_loop:
                             82 
                             83 	;;COMPROBAMOS QUE EL ITEM ES MAPA
                             84 	;; SI ES =0 MAPA TODAVIA POR PINTAR
                             85 	;; SI ES -1 es mapa que ya se ha pintado
                             86 	;; si es 1 es elemento normal
   7B0D F5            [11]   87 	push af
                             88 	
   7B0E DD 7E 11      [19]   89 	ld a, e_mapa(ix)
   7B11 D6 01         [ 7]   90 	sub #1
   7B13 28 11         [12]   91 	jr z,_es_uno ;;Si es cero (mapa=1)-> elemento normal
   7B15 DD 7E 11      [19]   92 	ld a, e_mapa(ix)
   7B18 C6 01         [ 7]   93 	add #1
   7B1A 28 07         [12]   94 	jr z, _es_menos_uno ;;si es cero, antes era menos 1 -> no pintamos
   7B1C                      95 _es_cero:
   7B1C 3E FF         [ 7]   96 	ld a, #-1
   7B1E DD 77 11      [19]   97 	ld e_mapa(ix), a
   7B21 18 03         [12]   98 	jr _es_uno
   7B23                      99 _es_menos_uno:
   7B23 F1            [10]  100 	pop af
   7B24 18 36         [12]  101 	jr _final_menos_uno
                            102 
   7B26                     103 _es_uno:
   7B26 F1            [10]  104 	pop af
                            105 
   7B27 DD 5E 15      [19]  106 	ld e, e_lastVP_l(ix)
   7B2A DD 56 16      [19]  107 	ld d, e_lastVP_h(ix)
                            108 	;;xor a ;;ponemos a 0 a para pintar en color de fondo
   7B2D DD 4E 04      [19]  109 	ld c, e_w(ix)
   7B30 DD 46 05      [19]  110 	ld b, e_h(ix)
   7B33 DD 66 07      [19]  111 	ld h, e_pspr_h(ix)
   7B36 DD 6E 06      [19]  112 	ld l, e_pspr_l(ix)
   7B39 C5            [11]  113 	push bc
   7B3A 3E 00         [ 7]  114 	ld a, #00
   7B3C CD A6 98      [17]  115 	call cpct_drawSolidBox_asm
                            116 	;call cpct_drawSpriteBlended_asm	;;pinto sobre el sprite anterior
                            117 	;;AL APLICAR DOS XOR SE VUELVE AL FONDO ORIGINAL (SE BORRA EL SPRITE
                            118 
                            119 	;;calculamos el puntero de la posicion actual
   7B3F 11 00 C0      [10]  120 	ld de, #0xC000
   7B42 DD 4E 00      [19]  121 	ld c, e_x(ix)
   7B45 DD 46 01      [19]  122 	ld b, e_y(ix)
   7B48 CD 95 99      [17]  123 	call cpct_getScreenPtr_asm
                            124 
                            125 	;;guardamos el nuevo puntero de memoria para borrar luego
                            126 
   7B4B DD 75 15      [19]  127 	ld e_lastVP_l(ix), l
   7B4E DD 74 16      [19]  128 	ld e_lastVP_h(ix), h	
                            129 
                            130 	;;Draw entity sprite
...
Hexadecimal [16-Bits]
                            ...
                            131 	
   7B51 EB            [ 4]  132 	ex de, hl
   7B52 DD 6E 06      [19]  133 	ld l, e_pspr_l(ix)
   7B55 DD 66 07      [19]  134 	ld h, e_pspr_h(ix)
   7B58 C1            [10]  135 	pop bc
   7B59 CD D7 97      [17]  136 	call cpct_drawSprite_asm		;;pintamos el sprite en el lugar correcto
                            137 	;;call cpct_drawSpriteBlended_asm
                            138 
   7B5C                     139 _final_menos_uno:
                            140 
                     0073   141 	_ent_counter = .+1 		;;estoy modificando el 0 con ent counter
   7B5C 3E 00         [ 7]  142 	ld a, #0				;;codigo automodificable
   7B5E 3D            [ 4]  143 	dec a
   7B5F C8            [11]  144 	ret z
                            145 
   7B60 32 5D 7B      [13]  146 	ld (_ent_counter), a
   7B63 01 17 00      [10]  147 	ld bc, #sizeof_e
   7B66 DD 09         [15]  148 	add ix, bc
   7B68 18 A3         [12]  149 	jr _update_loop
                            150 
                            151 
                            152 ;;BORRA ELEMENTOS
                            153 ;;INPUT IX-> entidad a borrar
   7B6A                     154 sys_eren_borrar::
   7B6A DD 5E 15      [19]  155 	ld e, e_lastVP_l(ix)
   7B6D DD 56 16      [19]  156 	ld d, e_lastVP_h(ix)
                            157 	;;xor a ;;ponemos a 0 a para pintar en color de fondo
   7B70 DD 46 04      [19]  158 	ld b, e_w(ix)
   7B73 DD 4E 05      [19]  159 	ld c, e_h(ix)
   7B76 DD 66 07      [19]  160 	ld h, e_pspr_h(ix)
   7B79 DD 6E 06      [19]  161 	ld l, e_pspr_l(ix)
   7B7C CD 4A 99      [17]  162 	call cpct_drawSpriteBlended_asm	;;pinto sobre el sprite anterior
                            163 	
   7B7F C9            [10]  164 	ret
