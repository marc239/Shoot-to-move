...
Hexadecimal [16-Bits]
                             ...
                             22 
                             23 ;;INPUT->
                             24 ;; IX: puntero al personaje
   7C17                      25 sys_dash_update::
                             26 
   7C17 DD 7E 02      [19]   27 	ld a, e_vx(ix);
   7C1A FE 00         [ 7]   28 	cp #0
   7C1C 28 11         [12]   29 	jr z, vx_parado
   7C1E FA 29 7C      [10]   30 	jp m, vx_negativo
   7C21                      31 vx_positivo:
                             32 
   7C21 06 FF         [ 7]   33 	ld b, #-1
   7C23 80            [ 4]   34 	add a, b
                             35 
   7C24 DD 77 02      [19]   36 	ld e_vx(ix), a
   7C27 18 06         [12]   37 	jr vx_parado
                             38 
   7C29                      39 vx_negativo:
                             40 
   7C29 06 01         [ 7]   41 	ld b, #1
   7C2B 80            [ 4]   42 	add a, b
                             43 
   7C2C DD 77 02      [19]   44 	ld e_vx(ix), a
                             45 
                             46 	;;SI VX ES POSITIVO-> restar 2 a vx
                             47 	;:SI VX es negativo -> sumar 2 a vx
   7C2F                      48 vx_parado:
                             49 
                             50 ;;PASAMOS A LA PARTE DE VY
                             51 
   7C2F DD 7E 03      [19]   52 	ld a, e_vy(ix)
   7C32 D6 04         [ 7]   53 	sub #4 ;;restamos 4 si 
   7C34 28 05         [12]   54 	jr z, vy_seguirCayendo
                             55 
   7C36 C6 05         [ 7]   56 	add #5
   7C38 DD 77 03      [19]   57 	ld e_vy(ix), a
                             58 
                             59 
   7C3B                      60 vy_seguirCayendo:
                             61 
   7C3B C9            [10]   62 	ret;
                             63 
