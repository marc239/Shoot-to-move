...
Hexadecimal [16-Bits]
                             ...
                             16 
                             17 ;;ESTE SISTEMA COMPRUEBA SI EL PERSONAJE A MUERTO
                             18 
...
Hexadecimal [16-Bits]
                             ...
                             23 
                             24 ;;INPUT:
                             25 ;;	ix->puntero al array de entidades
   77AD                      26 sys_death_update::
                             27 
                             28 	;;comprobamos si health del heroe es 0
   77AD 06 00         [ 7]   29 	ld b, #0
   77AF DD 7E 0B      [19]   30 	ld a, e_health(ix)
   77B2 FE 00         [ 7]   31 	cp #0
   77B4 C0            [11]   32 	ret nz	;;si la salud no es cero hacemos ret
   77B5 06 00         [ 7]   33 	ld b, #0
                             34 	;;si la salud es 0 saltamos al menu de restart
   77B7 C3 7E 76      [10]   35 	jp menu_restart
                             36 
                             37 	
                             38 ;;INPUT:
                             39 ;;	ix->puntero al array de entidades
   77BA                      40 sys_death_update_multi::
                             41 
                             42 	;;comprobamos si health del heroe es 0
   77BA 06 01         [ 7]   43 	ld b, #1
   77BC DD 7E 0B      [19]   44 	ld a, e_health(ix)
   77BF FE 00         [ 7]   45 	cp #0
   77C1 CA 7E 76      [10]   46 	jp z, menu_restart	;;si la salud no es cero hacemos ret
                             47 
   77C4 01 17 00      [10]   48 	ld bc, #sizeof_e
   77C7 DD 09         [15]   49 	add ix, bc
   77C9 DD 7E 0B      [19]   50 	ld a, e_health(ix)
   77CC FE 00         [ 7]   51 	cp #0
   77CE C0            [11]   52 	ret nz
                             53 
   77CF 06 02         [ 7]   54 	ld b,#2
                             55 	;;si la salud es 0 saltamos al menu de restart
   77D1 C3 7E 76      [10]   56 	jp menu_restart
                             57 
                             58 	
