...
Hexadecimal [16-Bits]
                             ...
                             22 .include "sys/sys_physics.h.s"
...
Hexadecimal [16-Bits]
                             ...
                             25 .include "sys/sys_ai_control.h.s"
...
Hexadecimal [16-Bits]
                             ...
                             32 
                             33 
   7A4A                      34 _ya_eliminado:
   7A4A 00                   35 	.db 0x00
                             36 
                             37 
                             38 
   7A4B                      39 sys_input_init::
   7A4B C9            [10]   40 	ret
                             41 
   7A4C 00                   42 _s_pulsada: .db 0x00
   7A4D 00                   43 _a_pulsada: .db 0x00
   7A4E 00                   44 _d_pulsada: .db 0x00
                             45 
                             46 
                             47 ;;FUNCIONA 
                             48 
                             49 ;;INPUT:
                             50 ;;	IX: puntero a la entidad [0] -> el personaje
                             51 
   7A4F                      52 sys_input_update::
                             53 
                             54 	;ld e_vx(ix), #0
                             55 	;ld e_vy(ix), #0 ;;RESETEAMOS VELOCIDADES
   7A4F DD E5         [15]   56 	push ix
   7A51 CD 9D 8E      [17]   57 	call cpct_scanKeyboard_f_asm
                             58 ;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
                             59 ;; PULSAR LA D
   7A54 21 07 20      [10]   60 	ld hl, #Key_D
   7A57 CD 91 8E      [17]   61 	call cpct_isKeyPressed_asm
   7A5A 28 1F         [12]   62 	jr z, D_NotPressed
   7A5C                      63 D_Pressed:
   7A5C 3A 4E 7A      [13]   64 	ld a, (_d_pulsada)
   7A5F FE 00         [ 7]   65 	cp #0
   7A61 20 1D         [12]   66 	jr nz, D_ya_pulsada
                             67 	;;AQUI LO QUE HACEMOS AL PULSAR LA A
   7A63 DD 36 02 FC   [19]   68 	ld e_vx(ix), #-4 ;;Ponemos velocidad
                             69 
   7A67 DD 56 00      [19]   70 	ld d, e_x(ix)
   7A6A DD 5E 01      [19]   71 	ld e, e_y(ix)
   7A6D 0E 01         [ 7]   72 	ld c, #1
   7A6F 06 02         [ 7]   73 	ld b, #2
   7A71 CD 3C 8E      [17]   74 	call man_entity_crearBala
                             75 	;;AHORA CREAMOS UNA BALA
                             76 	
                             77 	
   7A74 3E 01         [ 7]   78 	ld a, #1
   7A76 32 4E 7A      [13]   79 	ld (_d_pulsada), a
   7A79 18 69         [12]   80 	jr ya_pulsado
                             81 
   7A7B                      82 D_NotPressed:
   7A7B 3E 00         [ 7]   83 	ld a, #0
   7A7D 32 4E 7A      [13]   84 	ld (_d_pulsada), a
                             85 
...
Hexadecimal [16-Bits]
   ...
   7A80                      86 D_ya_pulsada:
                             87 ;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
                             88 ;;PULSAR LA A
                             89 ;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
   7A80 21 08 20      [10]   90 	ld hl, #Key_A
   7A83 CD 91 8E      [17]   91 	call cpct_isKeyPressed_asm
   7A86 28 1F         [12]   92 	jr z, A_NotPressed
   7A88                      93 A_Pressed:
   7A88 3A 4D 7A      [13]   94 	ld a, (_a_pulsada)
   7A8B FE 00         [ 7]   95 	cp #0
   7A8D 20 1D         [12]   96 	jr nz, A_ya_pulsada
                             97 	;;AQUI LO QUE HACEMOS AL PULSAR LA A
   7A8F DD 36 02 04   [19]   98 	ld e_vx(ix), #4 ;;Ponemos velocidad
                             99 
   7A93 DD 56 00      [19]  100 	ld d, e_x(ix)
   7A96 DD 5E 01      [19]  101 	ld e, e_y(ix)
   7A99 06 01         [ 7]  102 	ld b, #1
   7A9B 0E 01         [ 7]  103 	ld c, #1
   7A9D CD 3C 8E      [17]  104 	call man_entity_crearBala
                            105 	;;AHORA CREAMOS UNA BALA
                            106 	
                            107 	
   7AA0 3E 01         [ 7]  108 	ld a, #1
   7AA2 32 4D 7A      [13]  109 	ld (_a_pulsada), a
   7AA5 18 3D         [12]  110 	jr ya_pulsado
                            111 
   7AA7                     112 A_NotPressed:
   7AA7 3E 00         [ 7]  113 	ld a, #0
   7AA9 32 4D 7A      [13]  114 	ld (_a_pulsada), a
                            115 
   7AAC                     116 A_ya_pulsada:
                            117 ;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
                            118 
                            119 ;	ld hl, #Key_W
                            120 ;	call cpct_isKeyPressed_asm
                            121 ;	jr z, W_NotPressed
                            122 ;W_Pressed:
                            123 ;	ld a, (_w_pulsada)
                            124 ;	cp #0
                            125 ;	jr nz, W_ya_pulsada
                            126 ;	ld e_vy(ix), #4
                            127 ;	ld a, #1
                            128 ;	ld (_w_pulsada), a
                            129 ;	jr W_ya_pulsada
                            ...
                            137 ;;;PULSAR LA S
                            138 ;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
   7AAC 21 07 10      [10]  139 	ld hl, #Key_S
   7AAF CD 91 8E      [17]  140 	call cpct_isKeyPressed_asm
ASxxxx Assembler V02.00 + NoICE + SDCC mods  (Zilog Z80 / Hitachi HD64180), page 67.
Hexadecimal [16-Bits]



   7AB2 28 1F         [12]  141 	jr z, S_NotPressed
   7AB4                     142 S_Pressed:
   7AB4 3A 4C 7A      [13]  143 	ld a, (_s_pulsada)
   7AB7 FE 00         [ 7]  144 	cp #0
   7AB9 20 1D         [12]  145 	jr nz, S_ya_pulsada
                            146 	;;AQUI LO QUE HACEMOS AL PULSAR LA S
   7ABB DD 36 03 F8   [19]  147 	ld e_vy(ix), #-8 ;;Ponemos velocidad
                            148 
   7ABF DD 56 00      [19]  149 	ld d, e_x(ix)
   7AC2 DD 5E 01      [19]  150 	ld e, e_y(ix)
   7AC5 06 03         [ 7]  151 	ld b, #3
   7AC7 0E 01         [ 7]  152 	ld c, #1
   7AC9 CD 3C 8E      [17]  153 	call man_entity_crearBala
                            154 	;;AHORA CREAMOS UNA BALA
                            155 	
                            156 	
   7ACC 3E 01         [ 7]  157 	ld a, #1
   7ACE 32 4C 7A      [13]  158 	ld (_s_pulsada), a
   7AD1 18 11         [12]  159 	jr ya_pulsado
                            160 
   7AD3                     161 S_NotPressed:
   7AD3 3E 00         [ 7]  162 	ld a, #0
   7AD5 32 4C 7A      [13]  163 	ld (_s_pulsada), a
                            164 
   7AD8                     165 S_ya_pulsada:
                            166 ;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
                            167 
                            168 
                            169 ;;;TEMPORAL PARA PROBAR DELETE DE ENTIDADES
                            170 ;	ld hl, #Key_J
                            171 ;	call cpct_isKeyPressed_asm
                            172 ;	jr z, J_NotPressed
                            173 ;J_Pressed:
                            174 ;	ld a, (_ya_eliminado)
                            175 ;	cp #0
                            176 ;	jr nz, J_NotPressed 
                            177 ;	call man_entity_getArray
                            178 ;	ld__d_ixh  ;;INTRUCCIONES NO DOCUMENTADAS
                            179 ;	ld__e_ixl
                            180 ;	ld h, d
                            181 ;	ld l, e
                            182 ;	call man_entity_delete
                            183 ;	ld a, (_ya_eliminado)
                            184 ;	inc a
                            185 ;	ld (_ya_eliminado), a
                            186 
                            187 ;J_NotPressed:
                            188 
                            189 
                            190 	;;TEMPORAL PARA PROBAR IA
                            191 
                            192 	;ld e_ai_aim_x(ix), #0
                            193 
                            194 	;jr z, Spc_NotPressed
                            195 
...
Hexadecimal [16-Bits]
                            ...
                            196 ;Spc_Pressed:
                            197 	;ld e_ai_aim_x(ix), #1
                            198 
   7AD8 21 05 80      [10]  199 	ld hl, #Key_Space
   7ADB CD 91 8E      [17]  200 	call cpct_isKeyPressed_asm
   7ADE 28 04         [12]  201 	jr z, Spc_NotPressed
   7AE0                     202 Spc_Pressed:
   7AE0 DD 36 0C 01   [19]  203 	ld e_ai_aim_x(ix), #1
                            204 ;	call sys_jump_start
                            205 
   7AE4                     206 Spc_NotPressed:
                            207 
                            208 ;	call sys_jump_control
                            209 
                            210 ;;TEMPORAL PARA PROBAR STOP DE SALTO
                            211 
                            212 ;	ld hl, #Key_U
                            213 ;	call cpct_isKeyPressed_asm
                            214 ;	jr z, U_NotPressed
                            215 ;U_Pressed:
                            216 	;call sys_jump_stop
                            217 
                            218 ;U_NotPressed:
   7AE4                     219 ya_pulsado:
                            220 
   7AE4 DD E1         [14]  221 	pop ix
   7AE6 CD 17 7C      [17]  222 	call sys_dash_update
                            223 	;ld a, e_vx(ix)
                            224 	;sub #0
                            225 
                            226 ;;comprobamos restart
                            227 	;ld hl, #Key_F
                            228 	;call cpct_isKeyPressed_asm
                            229 	;jr z, F_restart_NotPressed
                            230 
                            231 	;jp start_game
                            232 
   7AE9                     233 F_restart_NotPressed:
   7AE9 C9            [10]  234 	ret
