...
Hexadecimal [16-Bits]
                             ...
                             23 
                             24 ;;INPUT A TODAS:
                             25 ;; IX -> entidad del personaje
                             26 
   7B80                      27 _tabla_salto:
   7B80 FD FC FC FD FD FE    28 	.db #-3, #-4, #-4, #-3, #-3, #-2, #-2, #0, #1, #1, #2, #2, #3, #3, #10
        FE 00 01 01 02 02
        03 03 0A
   7B8F                      29 _momento_salto:
   7B8F 00                   30 	.db #00
                             31 
                     000D    32 longitud_salto = 13
                             33 
                             34 
   7B90                      35 sys_jump_start::
                             36 
   7B90 3A 8F 7B      [13]   37 	ld a, (_momento_salto)
                             38 	;cp #00
                             39 	;jr nz, _ya_saltando
   7B93 3E 01         [ 7]   40 	ld a, #01
   7B95 32 8F 7B      [13]   41 	ld (_momento_salto), a ;;PONEMOS EL MOMENTO DE SALTO A UNO
                             42 
   7B98                      43 _ya_saltando:
                             44 
   7B98 C9            [10]   45 	ret
                             46 
   7B99                      47 sys_jump_control::
                             48 
   7B99 3A 8F 7B      [13]   49 	ld a, (_momento_salto) ;;cargamos el momento del salto
   7B9C FE 00         [ 7]   50 	cp #00
   7B9E 28 14         [12]   51 	jr z, _acabado ;;si no esta saltando no hacemos nada
                             52 	
                             53 
   7BA0 21 80 7B      [10]   54 	ld hl, #_tabla_salto ;;cargamos la posicion de la tabla en hl
   7BA3 06 00         [ 7]   55 	ld b, #00
   7BA5 4F            [ 4]   56 	ld c, a
                             57 
   7BA6 09            [11]   58 	add hl, bc ;;vamos a la posicion correcta de la tabla
                             59 
   7BA7 46            [ 7]   60 	ld b, (hl) ;;cargamos en b la velocidad correcta
   7BA8 DD 70 03      [19]   61 	ld e_vy(ix), b ;;ponemos la velocidad en la entidad
                             62 
   7BAB FE 0E         [ 7]   63 	cp #14
   7BAD 28 05         [12]   64 	jr z, _acabado
                             65 
   7BAF 3C            [ 4]   66 	inc a
   7BB0 32 8F 7B      [13]   67 	ld (_momento_salto), a ;;incrementamos el momento de salto
                             68 	
   7BB3 C9            [10]   69 	ret
                             70 
   7BB4                      71 _acabado:
...
Hexadecimal [16-Bits]
   ...
   7BB5                      75 sys_jump_stop::
                             76 
   7BB5 3E 00         [ 7]   77 	ld a, #00
   7BB7 32 8F 7B      [13]   78 	ld (_momento_salto), a
                             79 
   7BBA C9            [10]   80 	ret
