...
Hexadecimal [16-Bits]
                             ...
                             22 
                             23 .module sys_ai_control
                             24 
                     0032    25 contador_tiempo = 50
                             26 
                             27 
                             28 ;;INITS AI CONTROL
                             29 ;; INPUT:
                             30 ;; hl->puntero al array de entidades
   76A0                      31 sys_ai_control_init::
                             32 
   76A0 22 59 77      [16]   33 	ld (_ent_array_ptr), hl ;[6] modificac el array de entidades
                             34 
   76A3 22 AA 76      [16]   35 	ld (_ent_array_ptr_temp_standby), hl
                             36 
   76A6 C9            [10]   37 	ret
                             38 
   76A7                      39 sys_ai_nothing::
   76A7 C9            [10]   40 	ret
                             41 
   76A8                      42 sys_ai_stand_by::
                     000A    43 _ent_array_ptr_temp_standby = .+2
   76A8 FD 21 00 00   [14]   44 	ld iy, #0x0000
                             45 
   76AC FD 7E 0C      [19]   46 	ld a, e_ai_aim_x(iy)
   76AF B7            [ 4]   47 	or a
   76B0 C8            [11]   48 	ret z	;;si e_ai_aim_x no es cero entonces seguimos
                             49 
                             50 	;;PRESSED KEY -> move to player
                             51 
                             52 	;ld a, e_x(iy)
                             53 	;ld e_ai_aim_x(ix), a ;;guardamos la posicion del personaje como objetivo de la ia
                             54 	;ld a, e_y(iy)
                             55 	;ld e_ai_aim_y(ix), a
                             56 	;ld e_ai_st(ix), #e_ai_st_move_to
                             57 	;;ANTES DE LLAMAR A PATROL Pone el contador a cero
   76B1 3E 00         [ 7]   58 	ld a, #00
   76B3 CD FE 7F      [17]   59 	call man_patrol_get ;;devuelve en hl el step de la patrulla
   76B6 DD 75 13      [19]   60 	ld e_ai_patrol_step_l(ix), l
   76B9 DD 74 14      [19]   61 	ld e_ai_patrol_step_h(ix), h
   76BC DD 36 0F 01   [19]   62 	ld e_ai_pre_st(ix), #e_ai_st_stand_by
   76C0 DD 36 0E 03   [19]   63 	ld e_ai_st(ix), #e_ai_st_patrol
                             64 
   76C4 C9            [10]   65 	ret
                             66 
   76C5                      67 sys_ai_move_to::
                             68 
                             69 	;; Comprobamos si tiene que disparar o no
   76C5 DD 7E 10      [19]   70 	ld a, e_ai_contador(ix)
   76C8 D6 32         [ 7]   71 	sub #contador_tiempo
   76CA 20 38         [12]   72 	jr nz, _no_disparar ;;si es cero (=contadortiempo) disparamos
   76CC                      73 _disparar:
   76CC DD 36 10 00   [19]   74 	ld e_ai_contador(ix), #00
                             75 	;;calculamos hacia donde se debe mover la bala
                             76 	;; b> 0: y arriba
...
Hexadecimal [16-Bits]
                             ...
                             78 	;; 	2: x izquierda
                             79 	;;	3: y abajo 
   76D0 DD 7E 02      [19]   80 	ld a, e_vx(ix)
   76D3 FE 00         [ 7]   81 	cp #0 ;;Si vx  es cero, comprobamos vy
   76D5 28 0F         [12]   82 	jr z, _comprobarY
   76D7                      83 _comprobarVx:
   76D7 DD 7E 02      [19]   84 	ld a, e_vx(ix)
   76DA D6 00         [ 7]   85 	sub #0	;;si a menor que cero el carry se activa
   76DC 38 04         [12]   86 	jr c, _disparar_izquierda
   76DE                      87 _disparar_derecha:
   76DE 06 01         [ 7]   88 	ld b, #1
   76E0 18 11         [12]   89 	jr _nada
   76E2                      90 _disparar_izquierda:
   76E2 06 00         [ 7]   91 	ld b, #0
   76E4 18 0D         [12]   92 	jr _nada
                             93 
   76E6                      94 _comprobarY:
                             95 	;;comprobamos si vy es positivo
   76E6 DD 7E 03      [19]   96 	ld a, e_vy(ix)
   76E9 D6 01         [ 7]   97 	sub #1	;;si a menor que cero el carry se activa
   76EB 38 04         [12]   98 	jr c, _disparar_arriba
   76ED                      99 _disparar_abajo:
   76ED 06 03         [ 7]  100 	ld b, #3
   76EF 18 02         [12]  101 	jr _nada
   76F1                     102 _disparar_arriba:
   76F1 06 00         [ 7]  103 	ld b, #0
   76F3                     104 _nada:
                            105 	;;4341
                            106 	;;DE AL LLEGAR 00
                            107 	;;IX INICIAL 4A37
                            108 	;;4c4e
                            109 
   76F3 D5            [11]  110 	push de
   76F4 DD 56 00      [19]  111 	ld d, e_x(ix)
   76F7 DD 5E 01      [19]  112 	ld e, e_y(ix)
   76FA DD E5         [15]  113 	push ix
   76FC 0E 00         [ 7]  114 	ld c, #0
   76FE CD 3C 8E      [17]  115 	call man_entity_crearBala
   7701 DD E1         [14]  116 	pop ix
   7703 D1            [10]  117 	pop de
                            118 
   7704                     119 _no_disparar:
   7704 DD 7E 10      [19]  120 	ld a, e_ai_contador(ix)
   7707 3C            [ 4]  121 	inc a
   7708 DD 77 10      [19]  122 	ld e_ai_contador(ix), a
                            123 
   770B DD 36 03 00   [19]  124 	ld e_vy(ix), #0
                            125 
                            126 	;; if (obj_x > x) .....
                            127 	;; if (obj_x - x > 0)
                            128 	;; al restar si sale menor de 0 se activaria el carry
                            129 	;; si es mayor que 0 -> nc es cierto
                            130 	
   770F DD 7E 0C      [19]  131 	ld a, e_ai_aim_x(ix)  	;;A = x_objetivo
ASxxxx Assembler V02.00 + NoICE + SDCC mods  (Zilog Z80 / Hitachi HD64180), page 60.
Hexadecimal [16-Bits]



   7712 DD 96 00      [19]  132 	sub e_x(ix) 			;;A = obj_x - x
   7715 30 06         [12]  133 	jr nc, _objx_greater_or_equal		;; if(obj_x - x > 0) -> objx_greater
                            134 
   7717                     135 _objx_lesser:
   7717 DD 36 02 FF   [19]  136 	ld e_vx(ix), #-1
   771B 18 0C         [12]  137 	jr _endif_x
                            138 
   771D                     139 _objx_greater_or_equal:
   771D 28 06         [12]  140 	jr z, _arrived_x
   771F DD 36 02 01   [19]  141 	ld e_vx(ix), #1
   7723 18 04         [12]  142 	jr _endif_x
                            143 
   7725                     144 _arrived_x:
   7725 DD 36 02 00   [19]  145 	ld e_vx(ix), #0
                            146 	;ld e_ai_st(ix), #e_ai_st_stand_by
                            147 
   7729                     148 _endif_x: 
                            149 
                            150 ;;UPDATE Y
   7729 DD 7E 0D      [19]  151 	ld a, e_ai_aim_y(ix)  	;;A = x_objetivo
   772C DD 96 01      [19]  152 	sub e_y(ix) 			;;A = obj_x - x
   772F 30 06         [12]  153 	jr nc, _objy_greater_or_equal		;; if(obj_x - x > 0) -> objx_greater
                            154 
   7731                     155 _objy_lesser:
   7731 DD 36 03 FE   [19]  156 	ld e_vy(ix), #-2
   7735 18 1C         [12]  157 	jr _endif_y
                            158 
   7737                     159 _objy_greater_or_equal:
   7737 28 06         [12]  160 	jr z, _arrived_y
   7739 DD 36 03 02   [19]  161 	ld e_vy(ix), #2
   773D 18 14         [12]  162 	jr _endif_y
                            163 
   773F                     164 _arrived_y:
   773F DD 36 03 00   [19]  165 	ld e_vy(ix), #0
   7743 DD 7E 02      [19]  166 	ld a, e_vx(ix)
   7746 B7            [ 4]  167 	or a
   7747 20 0A         [12]  168 	jr nz, _endif_y ;;si a es 0 entonces hacemos stand by
                            169 
   7749 DD 7E 0F      [19]  170 	ld a, e_ai_pre_st(ix)
   774C DD 77 0E      [19]  171 	ld e_ai_st(ix), a
   774F DD 36 0F 02   [19]  172 	ld e_ai_pre_st(ix), #e_ai_st_move_to 
                            173 
   7753                     174 _endif_y: 
                            175 
   7753 C9            [10]  176 	ret
                            177 
                            178 ;;UPDATES AI CONTROL
                            179 ;; INPUT:
                            180 ;; A -> Numero de elementos del array
   7754                     181 sys_ai_control_update::
                            182 
   7754 32 72 77      [13]  183 	ld (_ent_counter), a
                            184 ;; Codigo automodificable
                     00B9   185 _ent_array_ptr = . + 2
   7757 DD 21 00 00   [14]  186 	ld ix, #0x0000	;;[4] cargamos el array de entidades en ix
...
Hexadecimal [16-Bits]
   ...
   775B                     188 _loop:
                            189 
   775B DD 7E 0E      [19]  190 	ld a, e_ai_st(ix)
   775E FE 00         [ 7]  191 	cp #e_ai_st_noAI ;;comparo la ia de la entidad con la de no AI
   7760 28 0F         [12]  192 	jr z, _no_AI_ent;;si ai es 0 no es AI, salto
                            193 
   7762                     194 _AI_ent:
                            195 
   7762 FE 01         [ 7]  196 	cp #e_ai_st_stand_by
   7764 CC A8 76      [17]  197 	call z, sys_ai_stand_by
   7767 FE 02         [ 7]  198 	cp #e_ai_st_move_to
   7769 CC C5 76      [17]  199 	call  z, sys_ai_move_to
   776C FE 03         [ 7]  200 	cp #e_ai_st_patrol
   776E CC 7F 77      [17]  201 	call  z, sys_ai_patrol
                            202 
   7771                     203 _no_AI_ent:
                            204 
                            205 
                            206 
                     00D2   207 _ent_counter = . + 1 ;;todo esto controla que recorra todas las entidades
   7771 3E 00         [ 7]  208 	ld a,#0
   7773 3D            [ 4]  209 	dec a
   7774 C8            [11]  210 	ret z
                            211 
   7775 32 72 77      [13]  212 	ld (_ent_counter),a
                            213 
                            214 
   7778 11 17 00      [10]  215 	ld de, #sizeof_e
   777B DD 19         [15]  216 	add ix, de
                            217 
   777D 18 DC         [12]  218 	jr _loop
                            219 
                            220 
                            221 ;;CONTROLA LA PATRULLA
                            222 ;;INPUT IX= Puntero a la entidad
                            223 ;; DESTRUYE : AF, IY
   777F                     224 sys_ai_patrol::
                            225 	;;HL apunta al siguiente (x,y) ai patrol step
   777F DD 6E 13      [19]  226 	ld l, e_ai_patrol_step_l(ix)
   7782 DD 66 14      [19]  227 	ld h, e_ai_patrol_step_h(ix)
                            228 
                            229 	;;COMPROBAR X!=-1
   7785 7E            [ 7]  230 	ld a, (hl)
   7786 FE FF         [ 7]  231 	cp #patrol_invalid_move_x
   7788 28 18         [12]  232 	jr z, _reset_patrol
                            233 
                            234 	
   778A DD 77 0C      [19]  235 	ld e_ai_aim_x(ix), a
   778D 23            [ 6]  236 	inc hl
   778E 7E            [ 7]  237 	ld a, (hl)
   778F DD 77 0D      [19]  238 	ld e_ai_aim_y(ix), a
                            239 
                            240 	;; INCREMENTAMOS HL PARA PASAR A LA SIGUIENTE X
   7792 23            [ 6]  241 	inc hl
ASxxxx Assembler V02.00 + NoICE + SDCC mods  (Zilog Z80 / Hitachi HD64180), page 62.
Hexadecimal [16-Bits]



   7793 DD 75 13      [19]  242 	ld e_ai_patrol_step_l(ix), l
   7796 DD 74 14      [19]  243 	ld e_ai_patrol_step_h(ix), h
                            244 
                            245 	;;CAMBIAMOS EL ESTADO
   7799 DD 36 0F 03   [19]  246 	ld e_ai_pre_st(ix), #e_ai_st_patrol
   779D DD 36 0E 02   [19]  247 	ld e_ai_st(ix), #e_ai_st_move_to
                            248 
                            249 	;ld a, e_ai_patrol_step(ix) ;;cargo el paso de la patrulla
                            250 	;cp #0
                            251 	;jr z, _step0
                            252 	;cp #1
                            253 	;jr z, _step1
   ...
   77A1 C9            [10]  255 	ret
                            256 
                            257 
   77A2                     258 _reset_patrol:
                            259 	;;GET NEXT 2 Bytes pointed by hl, que son el puntero al punto inicial
                            260 	;;de la patrulla
                            261 
   77A2 23            [ 6]  262 	inc hl
   77A3 7E            [ 7]  263 	ld a, (hl)
   77A4 23            [ 6]  264 	inc hl
   77A5 66            [ 7]  265 	ld h, (hl)
                            266 
                            267 	;;RESETEAMOS LA PATRULLA AL PRINCIPIO
   77A6 DD 77 13      [19]  268 	ld e_ai_patrol_step_l(ix), a
   77A9 DD 74 14      [19]  269 	ld e_ai_patrol_step_h(ix), h
                            270 
   77AC C9            [10]  271 	ret
