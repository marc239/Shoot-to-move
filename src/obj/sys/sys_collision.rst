...
Hexadecimal [16-Bits]
                             ...
                             16 
                             17 ;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
                             18 ;; SYSTEM THAT CHECKS COLLISIONS
                             19 ;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
...
Hexadecimal [16-Bits]
                             ...
                             25 
                             26 
   77D4 00                   27 _x_antigua_hero: .db 0x00
   77D5 00                   28 _y_antigua_hero: .db 0x00
   77D6 00                   29 _x_antigua_bala: .db 0x00
   77D7 00                   30 _y_antigua_bala: .db 0x00
                             31 
   77D8                      32 sys_collision_init::
                             33 
   77D8 C9            [10]   34 	ret
                             35 
                             36 ;;INPUT-> IX-> array de entidades
                             37 ;; 		A:: NUMERO DE ENTIDADES
   77D9                      38 sys_collision_update_hero::
                             39 	;;EMPEZAMOS IMPLEMENTANDO LAS COLISIONES DEL PERSONAJE (para fisicas)
                             40  	;;push ix
                             41  	;ld b, a ;;HACEMOS ESTO PARA EVITAR LLAMAR A GET ARRAY LUEGO
                             42  	;;push af;;SI VOLVEMOS A LLAMAR DA PROBLEMAS CON EL MULTIPLAYER
                             43  	;push bc
                             44  	;ld__d_ixh
                             45  	;ld__e_ixl
                             46  	;push de
                             ...
                             48 
                             49 
   77D9 D6 01         [ 7]   50  	sub #01
   77DB 47            [ 4]   51 	ld b, a ;; B = numero de entidades
                             52 	;;SI SOLO ES EL HEROE, no calculamos colisiones
   77DC FE 00         [ 7]   53 	cp #0
   77DE C8            [11]   54 	ret z
                             55 	;;pasamos a iy la entidad del heroe
                             56 
   000B                      57 	ld__d_ixh
   77DF DD 54                 1    .dw #0x54DD  ;; Opcode for ld d, ixh
   000D                      58 	ld__e_ixl
   77E1 DD 5D                 1    .dw #0x5DDD  ;; Opcode for ld e, ixl
   000F                      59 	ld__iyh_d
   77E3 FD 62                 1    .dw #0x62FD  ;; Opcode for ld iyh, d
   0011                      60 	ld__iyl_e
   77E5 FD 6B                 1    .dw #0x6BFD  ;; Opcode for ld iyl, e
                             61 
   77E7 11 17 00      [10]   62 	ld de, #sizeof_e
   77EA DD 19         [15]   63 	add ix, de
                             64 
                             65 ;;Primero probamos moviento x e y
   77EC FD 7E 00      [19]   66 	ld a, e_x(iy)
   77EF 32 D4 77      [13]   67 	ld (_x_antigua_hero), a
   77F2 FD 4E 02      [19]   68 	ld c, e_vx(iy)
   77F5 81            [ 4]   69 	add c
   77F6 FD 77 00      [19]   70 	ld e_x(iy), a
                             71 
   77F9 FD 7E 01      [19]   72 	ld a, e_y(iy)
   77FC 32 D5 77      [13]   73 	ld (_y_antigua_hero), a
   77FF FD 4E 03      [19]   74 	ld c, e_vy(iy)
   7802 81            [ 4]   75 	add c
...
Hexadecimal [16-Bits]
   ...
   7803 FD 77 01      [19]   76 	ld e_y(iy), a
                             77 
   7806                      78 _update_loop:
                             79 
                             80 	;;UNA VEZ HECHO ESO LLAMAMOS A COLLISION CHECK
                             81 	;;IY es el hero
   7806 0E 00         [ 7]   82 	ld c, #00;;ponemos c a cero, si colisiona, pasara a ser 1
   7808 CD 81 78      [17]   83 	call sys_collision_check
                             84 	
                             85 	;;SI YA HA COLISIONADO DEJAMOS DE BUSCAR:
   780B 79            [ 4]   86 	ld a, c
   780C D6 01         [ 7]   87 	sub #1
   780E 28 0A         [12]   88 	jr z, _salir_x_y
                             89 
   7810 05            [ 4]   90 	dec b
   7811 28 07         [12]   91 	jr z, _salir_x_y            ;;si no hay entidades acabamos 
                             92 
   7813 11 17 00      [10]   93 	ld de, #sizeof_e
   7816 DD 19         [15]   94 	add ix, de
   7818 18 EC         [12]   95 	jr _update_loop
                             96 
                             97 	;;si vx=0 ponemos la x antigua
   781A                      98 _salir_x_y:
                             99 
                            100 	;;AHORA PROBAMOS MOVIENDO SOLO LA 
                            101 
   781A 3A D4 77      [13]  102 	ld a, (_x_antigua_hero)
   781D FD 77 00      [19]  103 	ld e_x(iy), a
   7820 3A D5 77      [13]  104 	ld a, (_y_antigua_hero)
   7823 FD 77 01      [19]  105 	ld e_y(iy), a
                            106 
   7826 79            [ 4]  107 	ld a, c
   7827 D6 01         [ 7]  108 	sub #1
   7829 20 55         [12]  109 	jr nz, _no_colisiona
                            110 
   782B                     111 _si_colisiona_x_y:
   782B FD 36 03 00   [19]  112 	ld e_vy(iy), #00
                            113 
                            114 	;;comprobamos si es entidad final
   782F DD 7E 12      [19]  115 	ld a, e_final(ix)
   7832 FE 01         [ 7]  116 	cp #01
   7834 20 07         [12]  117 	jr nz, _no_es_final 
   7836 F1            [10]  118 	pop af
   7837 CD 96 75      [17]  119 	call inc_level
   783A CD E0 75      [17]  120 	call start_game
   783D                     121 _no_es_final:
                            122 
                            123 	;;SI COLISIONA MOVIENDO X E Y, COmprobamos moviendo solo en X
                            124 
   783D CD D3 8D      [17]  125 	call man_entity_getArray
                            126  	;pop de
                            127  	;ld__ixh_d
                            128  	;ld__ixl_e
                            129  	;pop bc
...
Hexadecimal [16-Bits]
                            ...
                            131 
                            132 
   7840 D6 01         [ 7]  133  	sub #01
   7842 47            [ 4]  134 	ld b, a ;; B = numero de entidades
                            135 	;;pasamos a iy la entidad del heroe
   006F                     136 	ld__d_ixh
   7843 DD 54                 1    .dw #0x54DD  ;; Opcode for ld d, ixh
   0071                     137 	ld__e_ixl
   7845 DD 5D                 1    .dw #0x5DDD  ;; Opcode for ld e, ixl
   0073                     138 	ld__iyh_d
   7847 FD 62                 1    .dw #0x62FD  ;; Opcode for ld iyh, d
   0075                     139 	ld__iyl_e
   7849 FD 6B                 1    .dw #0x6BFD  ;; Opcode for ld iyl, e
                            140 
   784B 11 17 00      [10]  141 	ld de, #sizeof_e
   784E DD 19         [15]  142 	add ix, de
                            143 
                            144 	;;Primero probamos moviento x e y
   7850 FD 7E 00      [19]  145 	ld a, e_x(iy)
   7853 32 D4 77      [13]  146 	ld (_x_antigua_hero), a
   7856 FD 4E 02      [19]  147 	ld c, e_vx(iy)
   7859 81            [ 4]  148 	add c
   785A FD 77 00      [19]  149 	ld e_x(iy), a
                            150 
   785D                     151 _update_loop2:
                            152 
                            153 	;;UNA VEZ HECHO ESO LLAMAMOS A COLLISION CHECK
                            154 	;;IY es el hero
   785D 0E 00         [ 7]  155 	ld c, #00;;ponemos c a cero, si colisiona, pasara a ser 1
   785F CD 81 78      [17]  156 	call sys_collision_check
                            157 	
                            158 	;;SI YA HA COLISIONADO DEJAMOS DE BUSCAR:
   7862 79            [ 4]  159 	ld a, c
   7863 D6 01         [ 7]  160 	sub #1
   7865 28 0A         [12]  161 	jr z, _salir_x
                            162 
   7867 05            [ 4]  163 	dec b
   7868 28 07         [12]  164 	jr z, _salir_x           ;;si no hay entidades acabamos 
                            165 
   786A 11 17 00      [10]  166 	ld de, #sizeof_e
   786D DD 19         [15]  167 	add ix, de
   786F 18 EC         [12]  168 	jr _update_loop2
                            169 
   7871                     170 _salir_x:
                            171 
   7871 3A D4 77      [13]  172 	ld a, (_x_antigua_hero)
   7874 FD 77 00      [19]  173 	ld e_x(iy), a
                            174 
   7877 79            [ 4]  175 	ld a, c
   7878 D6 01         [ 7]  176 	sub #1
   787A 20 04         [12]  177 	jr nz, _no_colisiona
   787C                     178 _si_colisiona_x:
   787C FD 36 02 00   [19]  179 	ld e_vx(iy), #00
                            180 
                            181 
...
Hexadecimal [16-Bits]
   ...
   7880 C9            [10]  185 	ret
                            ...
                            191 ;; IY -> entity 2
                            192 ;; RETURN:
                            193 ;; c->1/si colisiona
   7881                     194 sys_collision_check::
                            195 	;;heroe tiene un dos en colision
                            196 	;;comprobamos si iy es una bala que hace dmg al heroe
   7881 FD 7E 0A      [19]  197 	ld a, e_bal(iy)
   7884 FE 02         [ 7]  198 	cp #2
   7886 20 0E         [12]  199 	jr nz,  no_heroe;;no es bala disparada por el heroe	
                            200 
   7888 DD 7E 09      [19]  201 	ld a, e_col(ix);;comprobamos si es el heroe
   788B FE 04         [ 7]  202 	cp #4
   788D 28 07         [12]  203 	jr z, no_heroe
                            204 
   788F DD 7E 09      [19]  205 	ld a, e_col(ix);;comprobamos si es el heroe
   7892 FE 03         [ 7]  206 	cp #3
   7894 28 39         [12]  207 	jr z, _no_collision
                            208 
   7896                     209 no_heroe:
                            210 
                            211 	;;COMPROBAMOS SI EL OBJETO 2 ES COLISIONABLE O NO
   7896 DD 7E 09      [19]  212 	ld a, e_col(ix)
   7899 FE 00         [ 7]  213 	cp #0
   789B 28 32         [12]  214 	jr z, _no_collision
   789D FE 02         [ 7]  215 	cp #2
   789F 28 2E         [12]  216 	jr z, _no_collision
                            217 
                            218 	;;COMPROBAMOS EN X
                            219 	;;SI A<B : no colisionan
                            220 	;; if (e_x(ix) + e_w(ix) < e_x(iy)) ->no colisiona
                            221 	;; if (e_x(ix) + e_w(ix) - e_x(iy) < 0) ->no colisiona
                            222 
   78A1 DD 7E 00      [19]  223 	ld a, e_x(ix)
   78A4 DD 86 04      [19]  224 	add e_w(ix)
   78A7 FD 96 00      [19]  225 	sub e_x(iy) ;;al hacer sub, si a < 0 -> el carry se activa
   78AA 38 23         [12]  226 	jr c, _no_collision
                            227 
                            228 	;;SI C<D : no colisionan
                            229 	;; if (e_x(iy) + e_w(iy) < e_x(ix)) ->no colisiona
                            230 	;; if (e_x(iy) + e_w(iy) - e_x(ix) < 0) ->no colisiona
                            231 
   78AC FD 7E 00      [19]  232 	ld a, e_x(iy)
   78AF FD 86 04      [19]  233 	add e_w(iy)
   78B2 DD 96 00      [19]  234 	sub e_x(ix)
   78B5 38 18         [12]  235 	jr c, _no_collision
                            236 
...
Hexadecimal [16-Bits]
                            ...
                            237 
                            238 	;;;AHORA COMPROBAMOS EN Y
                            239 
   78B7 DD 7E 01      [19]  240 	ld a, e_y(ix)
   78BA DD 86 05      [19]  241 	add e_h(ix)
   78BD FD 96 01      [19]  242 	sub e_y(iy) ;;al hacer sub, si a < 0 -> el carry se activa
   78C0 38 0D         [12]  243 	jr c, _no_collision
                            244 
                            245 
   78C2 FD 7E 01      [19]  246 	ld a, e_y(iy)
   78C5 FD 86 05      [19]  247 	add e_h(iy)
   78C8 DD 96 01      [19]  248 	sub e_y(ix)
   78CB 38 02         [12]  249 	jr c, _no_collision
                            250 
   78CD 0E 01         [ 7]  251 	ld c, #01 ;;C es el return, si es 1 ha colisionado
                            252 
   78CF                     253 _no_collision:
                            254 
                            255 
   78CF C9            [10]  256 	ret
                            257 
                            258 
                            259 ;;INPUT-> IX-> array de entidades
                            260 ;; 		A:: NUMERO DE ENTIDADES
   78D0                     261 sys_collision_update_dmg::
                            262 	
                            263  	;;RECORREMOS TODOS LAS ENTIDADES MENOS LA PRIMERA(porque es el heroe, nunca va a ser dmg)
                            264  	;;Si es dmg, comprobamos is colisiona con algo
   78D0 D6 01         [ 7]  265  	sub #01
   78D2 47            [ 4]  266 	ld b, a ;; B = numero de entidades
                            267 
   78D3 11 17 00      [10]  268 	ld de, #sizeof_e
   78D6 DD 19         [15]  269 	add ix, de
                            270 
   78D8                     271 _update_loop_dmg: ;;ESTE BUCLE RECORRE LAS BALAS
                            272 	;;pasamos la bala a iy
   0104                     273 	ld__d_ixh
   78D8 DD 54                 1    .dw #0x54DD  ;; Opcode for ld d, ixh
   0106                     274 	ld__e_ixl
   78DA DD 5D                 1    .dw #0x5DDD  ;; Opcode for ld e, ixl
   0108                     275 	ld__iyh_d
   78DC FD 62                 1    .dw #0x62FD  ;; Opcode for ld iyh, d
   010A                     276 	ld__iyl_e
   78DE FD 6B                 1    .dw #0x6BFD  ;; Opcode for ld iyl, e
                            277 	;;Comprobamos si hace dmg
   78E0 FD 7E 09      [19]  278 	ld a, e_col(iy)
   78E3 D6 02         [ 7]  279 	sub #2
   78E5 20 56         [12]  280 	jr nz, _salir_interior
                            281 
                            282 	;;Modificamos x e y, guardando los originales
   78E7 FD 7E 00      [19]  283 	ld a, e_x(iy)
   78EA 32 D6 77      [13]  284 	ld (_x_antigua_bala), a
   78ED FD 4E 02      [19]  285 	ld c, e_vx(iy)
   78F0 81            [ 4]  286 	add c
   78F1 FD 77 00      [19]  287 	ld e_x(iy), a
...
Hexadecimal [16-Bits]
                            ...
                            288 
   78F4 FD 7E 01      [19]  289 	ld a, e_y(iy)
   78F7 32 D7 77      [13]  290 	ld (_y_antigua_bala), a
   78FA FD 4E 03      [19]  291 	ld c, e_vy(iy)
   78FD 81            [ 4]  292 	add c
   78FE FD 77 01      [19]  293 	ld e_y(iy), a
                            294 
                            295 	;;pasamos al bucle que comprueba si colisiona
   7901 CD D3 8D      [17]  296 	call man_entity_getArray
   7904 67            [ 4]  297 	ld h, a;;Usamos h para recorrer el array
   7905                     298 _update_loop_dmg_interior:
                            299 
   7905 0E 00         [ 7]  300 	ld c, #00;;ponemos c a cero, si colisiona, pasara a ser 1
   7907 CD 81 78      [17]  301 	call sys_collision_check
                            302 	
                            303 	;Comprobamos si colisiona
   790A 79            [ 4]  304 	ld a, c
   790B D6 01         [ 7]  305 	sub #1
   790D 20 24         [12]  306 	jr nz, _no_colisiona_dmg
                            307 
   790F 3E 00         [ 7]  308 	ld a, #0
   7911 CD 53 79      [17]  309 	call comprobarHeroEnemigo ;;nose porque no me deja poner el codigo aqui
                            310 	;;si colisiona ponemos bal a menos 1 , asi sabemos que hay que destruirla
   7914 FE 03         [ 7]  311 	cp #3 ;;si a es 3 saltamos a no colisiona
   7916 28 1B         [12]  312 	jr z, _no_colisiona_dmg
                            313 	;Si colisiona comprobamos si la entidad objetivo
                            314 	;;786B
                            315 	;;puede sufrir damage
   7918 DD 7E 0B      [19]  316 	ld a, e_health(ix)
   791B FE 00         [ 7]  317 	cp #0
   791D 28 14         [12]  318 	jr z, _no_colisiona_dmg;;si es 0 no puede sufrir dmg
                            319 
                            320 	;;Ahora restamos salud
   791F D6 01         [ 7]  321 	sub #1
   7921 DD 77 0B      [19]  322 	ld e_health(ix), a
   7924 20 0D         [12]  323 	jr nz, _no_colisiona_dmg ;;si no es cero seguimos
                            324 	;;si es cero borramos la entidad
   7926 C5            [11]  325 	push bc
   7927 E5            [11]  326 	push hl
                            327 	;;pasamos ix a hl
   0154                     328 	ld__b_ixh
   7928 DD 44                 1    .dw #0x44DD  ;; Opcode for ld b, ixh
   0156                     329 	ld__c_ixl 
   792A DD 4D                 1    .dw #0x4DDD  ;; Opcode for ld c, ixl
   792C 60            [ 4]  330 	ld h, b
   792D 69            [ 4]  331 	ld l, c
   792E CD 03 8E      [17]  332 	call man_entity_delete
   7931 E1            [10]  333 	pop hl
   7932 C1            [10]  334 	pop bc
                            335 	
                            336 
   7933                     337 _no_colisiona_dmg:
                            338 
   7933 25            [ 4]  339 	dec h
   7934 28 07         [12]  340 	jr z, _salir_interior            ;;si no hay entidades acabamos 
...
Hexadecimal [16-Bits]
                            ...
                            341 
   7936 11 17 00      [10]  342 	ld de, #sizeof_e
   7939 DD 19         [15]  343 	add ix, de
   793B 18 C8         [12]  344 	jr _update_loop_dmg_interior
                            345 
   793D                     346 _salir_interior:
                            347 
                            348 
                            349 	;;volvemos a poner ix
   0169                     350 	ld__d_iyh
   793D FD 54                 1    .dw #0x54FD  ;; Opcode for ld d, iyh
   016B                     351 	ld__e_iyl
   793F FD 5D                 1    .dw #0x5DFD  ;; Opcode for ld e, iyl
   016D                     352 	ld__ixh_d
   7941 DD 62                 1    .dw #0x62DD  ;; Opcode for ld ixh, d
   016F                     353 	ld__ixl_e
   7943 DD 6B                 1    .dw #0x6BDD  ;; Opcode for ld ixl, e
                            354 
                            355 
   7945 05            [ 4]  356 	dec b
   7946 28 07         [12]  357 	jr z, _salir_exterior          ;;si no hay entidades acabamos 
   7948 11 17 00      [10]  358 	ld de, #sizeof_e
   794B DD 19         [15]  359 	add ix, de
   794D 18 89         [12]  360 	jr _update_loop_dmg
                            361 
                            362 	;;si vx=0 ponemos la x antigua
   794F                     363 _salir_exterior:
                            364 
   794F CD 76 79      [17]  365 	call sys_collision_check_balas
                            366 
   7952 C9            [10]  367 	ret
                            368 
                            369 
   7953                     370 comprobarHeroEnemigo:
                            371 	;;4580
                            372 	;;comprobamos si la bala hace dmg a enemigos
   7953 FD 7E 0A      [19]  373 	ld a, e_bal(iy)
   7956 FE 02         [ 7]  374 	cp #2
   7958 28 0A         [12]  375 	jr z, _comprobarEnemigo ;;si es 2, comprobamos si el objeto con el que ha colisionado es enemigo
   795A                     376 _comprobarHeroe:
   795A DD 7E 0E      [19]  377 	ld a, e_ai_st(ix)
   795D FE 00         [ 7]  378 	cp #e_ai_st_noAI ;;comparo la ia de la entidad con la de no AI
   795F 28 10         [12]  379 	jr z, _acabar_comprobacion;;si ai es 0 no es AI, salto, si no es NOAI es enemigo
                            380 	;ld e_bal(iy), #-1
   7961 3E 03         [ 7]  381 	ld a, #3
   7963 C9            [10]  382 	ret
   7964                     383 _comprobarEnemigo:
                            384 	;;comprobamos si ix es enemigo, para eso probamos la IA
   7964 DD 7E 0E      [19]  385 	ld a, e_ai_st(ix)
   7967 FE 00         [ 7]  386 	cp #e_ai_st_noAI ;;comparo la ia de la entidad con la de no AI
   7969 20 06         [12]  387 	jr nz, _acabar_comprobacion;;si ai es 0 no es AI, salto, si no es NOAI es enemigo
   796B FD 36 0A FF   [19]  388 	ld e_bal(iy), #-1
   796F 3E 03         [ 7]  389 	ld a, #3
   7971                     390 _acabar_comprobacion:
                            391 
...
Hexadecimal [16-Bits]
   ...
   7971 FD 36 0A FF   [19]  392 	ld e_bal(iy), #-1
   7975 C9            [10]  393 	ret
                            394 
                            395 
                            396 ;;ESTA funcion comprueba si hay que destruir alguna bala
   7976                     397 sys_collision_check_balas::
                            398 
   7976 CD D3 8D      [17]  399 	call man_entity_getArray
                            400 
   7979 32 8E 79      [13]  401 	ld (_ent_counter), a ;;guardo el contador en una variable
                            402 
   797C                     403 _update_loop3:
                            404 
   797C DD 7E 0A      [19]  405 	ld a, e_bal(ix)
   797F C6 01         [ 7]  406 	add #1
   7981 20 0A         [12]  407 	jr nz, _nada_check ;;SI es cero entoces bal es -1->eliminamos
   7983                     408 _eliminar:
                            409 	;;pasamos IX a HL
   01AF                     410 	ld__d_ixh
   7983 DD 54                 1    .dw #0x54DD  ;; Opcode for ld d, ixh
   01B1                     411 	ld__e_ixl
   7985 DD 5D                 1    .dw #0x5DDD  ;; Opcode for ld e, ixl
   7987 EB            [ 4]  412 	ex de, hl
   7988 CD 03 8E      [17]  413 	call man_entity_delete
                            414 ;;volvemos a empezar el bucle para evitar errores(pero es mas lento)
   798B 18 E9         [12]  415 	jr sys_collision_check_balas
   798D                     416 _nada_check:
                            417 	
                     01BA   418 	_ent_counter = .+1 		;;estoy modificando el 0 con ent counter
   798D 3E 00         [ 7]  419 	ld a, #0				;;codigo automodificable
   798F 3D            [ 4]  420 	dec a
   7990 C8            [11]  421 	ret z
                            422 
   7991 32 8E 79      [13]  423 	ld (_ent_counter), a
   7994 01 17 00      [10]  424 	ld bc, #sizeof_e
   7997 DD 09         [15]  425 	add ix, bc
   7999 18 E1         [12]  426 	jr _update_loop3
                            427 
                            428 
                            429 
   799B C9            [10]  430 	ret
                            431 
                            432 ;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
                            433 ;PARA EL MULTIJUGADOR
                            434 ;;COPIA PEGA DE LA PRIMERA
                            435 ;;SE PUEDE HACER MUCHO MEJOR
                            436 
                            437 ;;INPUT-> IX-> array de entidades
                            438 ;; 		A:: NUMERO DE ENTIDADES
   799C                     439 sys_collision_update_hero2::
                            440 	;;EMPEZAMOS IMPLEMENTANDO LAS COLISIONES DEL PERSONAJE (para fisicas)
                            441 
                            442 
   799C D6 01         [ 7]  443  	sub #01
   799E 47            [ 4]  444 	ld b, a ;; B = numero de entidades
ASxxxx Assembler V02.00 + NoICE + SDCC mods  (Zilog Z80 / Hitachi HD64180), page 66.
Hexadecimal [16-Bits]



                            445 	;;SI SOLO ES EL HEROE, no calculamos colisiones
   799F FE 00         [ 7]  446 	cp #0
   79A1 C8            [11]  447 	ret z
                            448 	;;pasamos a iy la entidad del heroe
                            449 
   01CE                     450 	ld__d_ixh
   79A2 DD 54                 1    .dw #0x54DD  ;; Opcode for ld d, ixh
   01D0                     451 	ld__e_ixl
   79A4 DD 5D                 1    .dw #0x5DDD  ;; Opcode for ld e, ixl
   01D2                     452 	ld__iyh_d
   79A6 FD 62                 1    .dw #0x62FD  ;; Opcode for ld iyh, d
   01D4                     453 	ld__iyl_e
   79A8 FD 6B                 1    .dw #0x6BFD  ;; Opcode for ld iyl, e
                            454 
   79AA 11 17 00      [10]  455 	ld de, #sizeof_e
   79AD DD 19         [15]  456 	add ix, de
                            457 
                            458 ;;Primero probamos moviento x e y
   79AF FD 7E 00      [19]  459 	ld a, e_x(iy)
   79B2 32 D4 77      [13]  460 	ld (_x_antigua_hero), a
   79B5 FD 4E 02      [19]  461 	ld c, e_vx(iy)
   79B8 81            [ 4]  462 	add c
   79B9 FD 77 00      [19]  463 	ld e_x(iy), a
                            464 
   79BC FD 7E 01      [19]  465 	ld a, e_y(iy)
   79BF 32 D5 77      [13]  466 	ld (_y_antigua_hero), a
   79C2 FD 4E 03      [19]  467 	ld c, e_vy(iy)
   79C5 81            [ 4]  468 	add c
   79C6 FD 77 01      [19]  469 	ld e_y(iy), a
                            470 
   79C9                     471 _update_loop21:
                            472 
                            473 	;;UNA VEZ HECHO ESO LLAMAMOS A COLLISION CHECK
                            474 	;;IY es el hero
   79C9 0E 00         [ 7]  475 	ld c, #00;;ponemos c a cero, si colisiona, pasara a ser 1
   79CB CD 81 78      [17]  476 	call sys_collision_check
                            477 	
                            478 	;;SI YA HA COLISIONADO DEJAMOS DE BUSCAR:
   79CE 79            [ 4]  479 	ld a, c
   79CF D6 01         [ 7]  480 	sub #1
   79D1 28 0A         [12]  481 	jr z, _salir_x_y21
                            482 
   79D3 05            [ 4]  483 	dec b
   79D4 28 07         [12]  484 	jr z, _salir_x_y21            ;;si no hay entidades acabamos 
                            485 
   79D6 11 17 00      [10]  486 	ld de, #sizeof_e
   79D9 DD 19         [15]  487 	add ix, de
   79DB 18 EC         [12]  488 	jr _update_loop21
                            489 
                            490 	;;si vx=0 ponemos la x antigua
   79DD                     491 _salir_x_y21:
                            492 
                            493 	;;AHORA PROBAMOS MOVIENDO SOLO LA 
                            494 
   79DD 3A D4 77      [13]  495 	ld a, (_x_antigua_hero)
ASxxxx Assembler V02.00 + NoICE + SDCC mods  (Zilog Z80 / Hitachi HD64180), page 67.
Hexadecimal [16-Bits]



   79E0 FD 77 00      [19]  496 	ld e_x(iy), a
   79E3 3A D5 77      [13]  497 	ld a, (_y_antigua_hero)
   79E6 FD 77 01      [19]  498 	ld e_y(iy), a
                            499 
   79E9 79            [ 4]  500 	ld a, c
   79EA D6 01         [ 7]  501 	sub #1
   79EC 20 5B         [12]  502 	jr nz, _no_colisiona21
                            503 
   79EE                     504 _si_colisiona_x_y21:
   79EE FD 36 03 00   [19]  505 	ld e_vy(iy), #00
                            506 
                            507 	;;comprobamos si es entidad final
   79F2 DD 7E 12      [19]  508 	ld a, e_final(ix)
   79F5 FE 01         [ 7]  509 	cp #01
   79F7 20 07         [12]  510 	jr nz, _no_es_final21 
   79F9 F1            [10]  511 	pop af
   79FA CD 96 75      [17]  512 	call inc_level
   79FD CD E0 75      [17]  513 	call start_game
   7A00                     514 _no_es_final21:
                            515 
   7A00 CD D3 8D      [17]  516 	call man_entity_getArray
   7A03 01 17 00      [10]  517 	ld bc, #sizeof_e
   7A06 DD 09         [15]  518 	add ix, bc
   7A08 3D            [ 4]  519 	dec a
                            520 
   7A09 D6 01         [ 7]  521  	sub #01
   7A0B 47            [ 4]  522 	ld b, a ;; B = numero de entidades
                            523 	;;pasamos a iy la entidad del heroe
   0238                     524 	ld__d_ixh
   7A0C DD 54                 1    .dw #0x54DD  ;; Opcode for ld d, ixh
   023A                     525 	ld__e_ixl
   7A0E DD 5D                 1    .dw #0x5DDD  ;; Opcode for ld e, ixl
   023C                     526 	ld__iyh_d
   7A10 FD 62                 1    .dw #0x62FD  ;; Opcode for ld iyh, d
   023E                     527 	ld__iyl_e
   7A12 FD 6B                 1    .dw #0x6BFD  ;; Opcode for ld iyl, e
                            528 
   7A14 11 17 00      [10]  529 	ld de, #sizeof_e
   7A17 DD 19         [15]  530 	add ix, de
                            531 
                            532 	;;Primero probamos moviento x e y
   7A19 FD 7E 00      [19]  533 	ld a, e_x(iy)
   7A1C 32 D4 77      [13]  534 	ld (_x_antigua_hero), a
   7A1F FD 4E 02      [19]  535 	ld c, e_vx(iy)
   7A22 81            [ 4]  536 	add c
   7A23 FD 77 00      [19]  537 	ld e_x(iy), a
                            538 
   7A26                     539 _update_loop221:
                            540 
                            541 	;;UNA VEZ HECHO ESO LLAMAMOS A COLLISION CHECK
                            542 	;;IY es el hero
   7A26 0E 00         [ 7]  543 	ld c, #00;;ponemos c a cero, si colisiona, pasara a ser 1
   7A28 CD 81 78      [17]  544 	call sys_collision_check
                            545 	
                            546 	;;SI YA HA COLISIONADO DEJAMOS DE BUSCAR:
ASxxxx Assembler V02.00 + NoICE + SDCC mods  (Zilog Z80 / Hitachi HD64180), page 68.
Hexadecimal [16-Bits]



   7A2B 79            [ 4]  547 	ld a, c
   7A2C D6 01         [ 7]  548 	sub #1
   7A2E 28 0A         [12]  549 	jr z, _salir_x21
                            550 
   7A30 05            [ 4]  551 	dec b
   7A31 28 07         [12]  552 	jr z, _salir_x21           ;;si no hay entidades acabamos 
                            553 
   7A33 11 17 00      [10]  554 	ld de, #sizeof_e
   7A36 DD 19         [15]  555 	add ix, de
   7A38 18 EC         [12]  556 	jr _update_loop221
                            557 
   7A3A                     558 _salir_x21:
                            559 
   7A3A 3A D4 77      [13]  560 	ld a, (_x_antigua_hero)
   7A3D FD 77 00      [19]  561 	ld e_x(iy), a
                            562 
   7A40 79            [ 4]  563 	ld a, c
   7A41 D6 01         [ 7]  564 	sub #1
   7A43 20 04         [12]  565 	jr nz, _no_colisiona21
   7A45                     566 _si_colisiona_x21:
   7A45 FD 36 02 00   [19]  567 	ld e_vx(iy), #00
                            568 
                            569 
                            570 
   7A49                     571 _no_colisiona21: 
                            572 
   7A49 C9            [10]  573 	ret
