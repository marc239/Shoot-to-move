...
Hexadecimal [16-Bits]
                             ...
                             25 
                             26 
   88AB 53 48 4F 4F 54 20    27 string_titulo:: .asciz "SHOOT TO MOVE"
        54 4F 20 4D 4F 56
        45 00
   88B9 43 4C 41 53 53 49    28 string_start:: .asciz "CLASSIC"
        43 00
   88C1 4D 55 4C 54 49 50    29 string_multi:: .asciz "MULTIPLAYER"
        4C 41 59 45 52 00
   88CD 41 52 43 41 44 45    30 string_arcade:: .asciz "ARCADE"
        00
   88D4 43 52 45 44 49 54    31 string_creditos:: .asciz "CREDITS"
        53 00
   88DC 47 61 6D 65 20 64    32 string_cred_linea1:: .asciz "Game develop by"
        65 76 65 6C 6F 70
        20 62 79 00
   88EC 4D 61 72 63 20 4C    33 string_cred_linea2:: .asciz "Marc Landes Molla"
        61 6E 64 65 73 20
        4D 6F 6C 6C 61 00
   88FE 50 6C 61 79 65 72    34 string_restart_1:: .asciz "Player 1 wins"
        20 31 20 77 69 6E
        73 00
   890C 50 6C 61 79 65 72    35 string_restart_2:: .asciz "Player 2 wins"
        20 32 20 77 69 6E
        73 00
   891A 50 72 65 73 73 20    36 string_restart_normal1:: .asciz "Press F to restart"
        46 20 74 6F 20 72
        65 73 74 61 72 74
        00
   892D 45 73 63 20 74 6F    37 string_restart_normal2:: .asciz "Esc to go back"
        20 67 6F 20 62 61
        63 6B 00
   893C 50 72 65 73 73 20    38 string_elige_nivel:: .asciz "Press 1, 2 or 3"
        31 2C 20 32 20 6F
        72 20 33 00
   894C 74 6F 20 73 65 6C    39 string_elige_nivel2:: .asciz "to select level"
        65 63 74 20 6C 65
        76 65 6C 00
                             40 
   895C 00                   41 _opcion_seleccionada: .db 0x00
   895D 00 C0                42 _direccion_antigua: .dw 0xC000
                             43 
   895F 00                   44 _up_pulsada: .db 0x00
   8960 00                   45 _down_pulsada: .db 0x00
                             46 
                             47 ;;ESTO MUESTRA EL MENU PRINCIPAL
   8961                      48 man_menu_inicial_init::
                             49 
   8961 0E 00         [ 7]   50 	ld c, #0
   8963 CD 89 98      [17]   51 	call cpct_setVideoMode_asm ;;pone el modo de video a uno
   8966 21 44 75      [10]   52 	ld hl, #_main_pal
   8969 11 10 00      [10]   53 	ld de, #16
   896C CD 07 8F      [17]   54 	call cpct_setPalette_asm
                             55 
...
Hexadecimal [16-Bits]
   ...
   896F 26 00         [ 7]   56 	ld    h, #0         ;; C= Background PEN ()
   8971 2E 0F         [ 7]   57 	ld    l, #15         ;; B = Foreground PEN ()
                             58 
   8973 CD 72 99      [17]   59 	call cpct_setDrawCharM0_asm
                             60 
   8976 11 00 C0      [10]   61 	ld   de, #CPCT_VMEM_START_ASM ;; DE = Pointer to start of the screen
   8979 06 18         [ 7]   62    	ld    b, #24                  ;; B = y coordinate (24 = 0x18)
   897B 0E 0D         [ 7]   63 	ld    c, #13                  ;; C = x coordinate (16 = 0x10)
                             64 
   897D CD 95 99      [17]   65 	call cpct_getScreenPtr_asm	
                             66 
   8980 FD 21 AB 88   [14]   67 	ld   iy, #string_titulo    ;; IY = Pointer to the string 
                             68 
   8984 CD 4D 97      [17]   69 	call cpct_drawStringM0_asm
                             70 
                             71 	;;DIBUJAR START
   8987 11 00 C0      [10]   72 	ld   de, #CPCT_VMEM_START_ASM ;; DE = Pointer to start of the screen
   898A 06 46         [ 7]   73    	ld    b, #70                  ;; B = y coordinate (24 = 0x18)
   898C 0E 0F         [ 7]   74 	ld    c, #15                  ;; C = x coordinate (16 = 0x10)
   898E CD 95 99      [17]   75 	call cpct_getScreenPtr_asm	
   8991 FD 21 B9 88   [14]   76 	ld   iy, #string_start    ;; IY = Pointer to the string 
   8995 CD 4D 97      [17]   77 	call cpct_drawStringM0_asm
                             78 
   8998 11 00 C0      [10]   79 	ld   de, #CPCT_VMEM_START_ASM ;; DE = Pointer to start of the screen
   899B 06 5A         [ 7]   80    	ld    b, #90                  ;; B = y coordinate (24 = 0x18)
   899D 0E 0F         [ 7]   81 	ld    c, #15                  ;; C = x coordinate (16 = 0x10)
   899F CD 95 99      [17]   82 	call cpct_getScreenPtr_asm	
   89A2 FD 21 C1 88   [14]   83 	ld   iy, #string_multi    ;; IY = Pointer to the string 
   89A6 CD 4D 97      [17]   84 	call cpct_drawStringM0_asm
                             85 
   89A9 11 00 C0      [10]   86 	ld   de, #CPCT_VMEM_START_ASM ;; DE = Pointer to start of the screen
   89AC 06 6E         [ 7]   87    	ld    b, #110                  ;; B = y coordinate (24 = 0x18)
   89AE 0E 0F         [ 7]   88 	ld    c, #15                  ;; C = x coordinate (16 = 0x10)
   89B0 CD 95 99      [17]   89 	call cpct_getScreenPtr_asm	
   89B3 FD 21 D4 88   [14]   90 	ld   iy, #string_creditos    ;; IY = Pointer to the string 
   89B7 CD 4D 97      [17]   91 	call cpct_drawStringM0_asm
                             92 
                             93 	;ld   de, #CPCT_VMEM_START_ASM ;; DE = Pointer to start of the screen
                             94    	;ld    b, #130                  ;; B = y coordinate (24 = 0x18)
                             95 	;ld    c, #15                  ;; C = x coordinate (16 = 0x10)
                             96 	;call cpct_getScreenPtr_asm	
                             97 	;ld   iy, #string_creditos    ;; IY = Pointer to the string 
                             98 	;call cpct_drawStringM0_asm
                             99 
   89BA C9            [10]  100 	ret
                            101 
   89BB                     102 man_menu_inicial_update::
                            103 
                            104 	;;OPCION 0-> start
                            105 	;;OPCION 1-> creditos
                            106 	;;primero borramos el antiguo
                            107 	;;PRIMERO COMPROBAMOS EL INPUT
   89BB CD 9D 8E      [17]  108 	call cpct_scanKeyboard_f_asm
                            109 
   89BE 21 00 01      [10]  110 	ld hl, #Key_CursorUp
ASxxxx Assembler V02.00 + NoICE + SDCC mods  (Zilog Z80 / Hitachi HD64180), page 59.
Hexadecimal [16-Bits]



   89C1 CD 91 8E      [17]  111 	call cpct_isKeyPressed_asm
   89C4 28 19         [12]  112 	jr z, Up_NotPressed
   89C6                     113 Up_Pressed:
                            114 	;;SI PULSA LA D RESTAMOS Comprobamos si es 0
   89C6 3A 5F 89      [13]  115 	ld a, (_up_pulsada)
   89C9 FE 00         [ 7]  116 	cp #0
   89CB 20 17         [12]  117 	jr nz, Up_alreadyPressed
                            118 
   89CD 3A 5C 89      [13]  119 	ld a, (_opcion_seleccionada) 
   89D0 FE 00         [ 7]  120 	cp #0
   89D2 28 0B         [12]  121 	jr z, Up_NotPressed ;;Si es cero no hacemos nada
                            122 	;;si no es cero le restamos uno
   89D4 3D            [ 4]  123 	dec a
   89D5 32 5C 89      [13]  124 	ld (_opcion_seleccionada), a
                            125 
   89D8 3E 01         [ 7]  126 	ld a, #1
   89DA 32 5F 89      [13]  127 	ld (_up_pulsada), a
   89DD 18 05         [12]  128 	jr Up_alreadyPressed
   89DF                     129 Up_NotPressed:
   89DF 3E 00         [ 7]  130 	ld a, #0
   89E1 32 5F 89      [13]  131 	ld (_up_pulsada), a
   89E4                     132 Up_alreadyPressed:
                            133 
   89E4 21 00 04      [10]  134 	ld hl, #Key_CursorDown
   89E7 CD 91 8E      [17]  135 	call cpct_isKeyPressed_asm
   89EA 28 1C         [12]  136 	jr z, Down_NotPressed
   89EC                     137 Down_Pressed:
   89EC 3A 60 89      [13]  138 	ld a, (_down_pulsada)
   89EF FE 00         [ 7]  139 	cp #0
   89F1 20 1A         [12]  140 	jr nz, Down_alreadyPressed
                            141 	;;SI PULSA LA D RESTAMOS Comprobamos si es 0
   89F3 3A 5C 89      [13]  142 	ld a, (_opcion_seleccionada) 
   89F6 D6 02         [ 7]  143 	sub #2
   89F8 28 0E         [12]  144 	jr z, Down_NotPressed ;;Si es cero no hacemos nada
                            145 	;;si no es cero le restamos uno
   89FA 3C            [ 4]  146 	inc a
   89FB 3C            [ 4]  147 	inc a
   89FC 3C            [ 4]  148 	inc a
   89FD 3C            [ 4]  149 	inc a
   89FE 32 5C 89      [13]  150 	ld (_opcion_seleccionada), a
                            151 
   8A01 3E 01         [ 7]  152 	ld a, #1
   8A03 32 60 89      [13]  153 	ld (_down_pulsada), a
   8A06 18 05         [12]  154 	jr Down_alreadyPressed
   8A08                     155 Down_NotPressed:
   8A08 3E 00         [ 7]  156 	ld a, #0
   8A0A 32 60 89      [13]  157 	ld (_down_pulsada), a
   8A0D                     158 Down_alreadyPressed:
                            159 
                            160 
   8A0D CD 37 8A      [17]  161 	call man_menu_principal_renderSelected
                            162 
                            163 
                            164 	;;AHORA COMPROBAMOS SI PULSA ENTER
   8A10 21 06 20      [10]  165 	ld hl, #Key_F
ASxxxx Assembler V02.00 + NoICE + SDCC mods  (Zilog Z80 / Hitachi HD64180), page 60.
Hexadecimal [16-Bits]



   8A13 CD 91 8E      [17]  166 	call cpct_isKeyPressed_asm
   8A16 28 1E         [12]  167 	jr z, Enter_NotPressed
   8A18                     168 Enter_Pressed:
   8A18 3A 5C 89      [13]  169 	ld a, (_opcion_seleccionada)
   8A1B FE 02         [ 7]  170 	cp #2
   8A1D 20 03         [12]  171 	jr nz, no_creditos
   8A1F C3 D1 75      [10]  172 	jp startCreditos
   8A22                     173 no_creditos:
   8A22 FE 00         [ 7]  174 	cp #0
   8A24 20 06         [12]  175 	jr nz, no_normal
                            176 	;;AQUI CUANDO EMPIEZA NORMAL
   8A26 CD A8 75      [17]  177 	call set_individual
   8A29 C3 E0 75      [10]  178 	jp start_game
   8A2C                     179 no_normal:
   8A2C FE 01         [ 7]  180 	cp #1
   8A2E 20 06         [12]  181 	jr nz, Enter_NotPressed
   8A30 CD A2 75      [17]  182 	call set_multiplayer
   8A33 C3 73 76      [10]  183 	jp menu_nivel_multi
   8A36                     184 Enter_NotPressed:
   8A36 C9            [10]  185 	ret
                            186 
                            187 
                            188 
   8A37                     189 man_menu_principal_renderSelected:
                            190 
                            191 	;;comprobamos cual es la opcion seleccionada
                            192 
   8A37 ED 5B 5D 89   [20]  193 	ld de, (_direccion_antigua)
   8A3B 3E 00         [ 7]  194 	ld a, #0x00
   8A3D 0E 02         [ 7]  195 	ld c, #2
   8A3F 06 04         [ 7]  196 	ld b, #4
   8A41 CD A6 98      [17]  197 	call cpct_drawSolidBox_asm
                            198 
   8A44 3A 5C 89      [13]  199 	ld a, (_opcion_seleccionada)
                            200 
   8A47 11 00 C0      [10]  201 	ld de, #0xC000
   8A4A 0E 0A         [ 7]  202 	ld c, #10 ;;x 
                            203 	;;AHORA CARGAMOS EN B EN BASE A LA OPCION ELEGIDA
                            204 	;;PRIMERO COMPROBAMOS SI ES 0 0 1 2 3 
   8A4C 06 46         [ 7]  205 	ld b, #70
   8A4E FE 00         [ 7]  206 	cp #0
   8A50 28 0E         [12]  207 	jr z, _acabado
                            208 	;;ahora vamos restando
   8A52 06 5A         [ 7]  209 	ld b, #90
   8A54 D6 01         [ 7]  210 	sub #1
   8A56 28 08         [12]  211 	jr z, _acabado
   8A58 06 6E         [ 7]  212 	ld b, #110
   8A5A D6 01         [ 7]  213 	sub #1
   8A5C 28 02         [12]  214 	jr z, _acabado
   8A5E 06 82         [ 7]  215 	ld b, #130
   8A60                     216 _acabado:
   8A60 CD 95 99      [17]  217     	call cpct_getScreenPtr_asm
                            218 
   8A63 22 5D 89      [16]  219     	ld (_direccion_antigua), hl
                            220 
...
Hexadecimal [16-Bits]
   ...
   8A66 EB            [ 4]  221 	ex de, hl
   8A67 3E FF         [ 7]  222 	ld a, #0xFF
   8A69 0E 02         [ 7]  223 	ld c, #2
   8A6B 06 04         [ 7]  224 	ld b, #4
   8A6D CD A6 98      [17]  225 	call cpct_drawSolidBox_asm
                            226 
   8A70 C9            [10]  227 	ret
                            228 
                            229 
   8A71                     230 man_menu_creditos_init::
                            231 
                            232 	;;PRIMERO LIMPIAMOS LA PANTALLA
   8A71 11 00 C0      [10]  233 	ld de, #0xC000
   8A74 3E 00         [ 7]  234 	ld a, #0x00
   8A76 0E 40         [ 7]  235 	ld c, #64 ;;ANCHURA
   8A78 06 C8         [ 7]  236 	ld b, #200
   8A7A CD A6 98      [17]  237 	call cpct_drawSolidBox_asm
                            238 
                            239 
   8A7D 11 00 C0      [10]  240 	ld   de, #0xC000 ;; DE = Pointer to start of the screen
   8A80 06 18         [ 7]  241    	ld    b, #24                  ;; B = y coordinate (24 = 0x18)
   8A82 0E 0D         [ 7]  242 	ld    c, #13                  ;; C = x coordinate (16 = 0x10)
   8A84 CD 95 99      [17]  243 	call cpct_getScreenPtr_asm	
   8A87 FD 21 AB 88   [14]  244 	ld   iy, #string_titulo    ;; IY = Pointer to the string 
   8A8B CD 4D 97      [17]  245 	call cpct_drawStringM0_asm
                            246 
   8A8E 11 00 C0      [10]  247 	ld   de, #0xC000 ;; DE = Pointer to start of the screen
   8A91 06 5A         [ 7]  248    	ld    b, #90                  ;; B = y coordinate (24 = 0x18)
   8A93 0E 0A         [ 7]  249 	ld    c, #10                 ;; C = x coordinate (16 = 0x10)
   8A95 CD 95 99      [17]  250 	call cpct_getScreenPtr_asm	
   8A98 FD 21 DC 88   [14]  251 	ld   iy, #string_cred_linea1    ;; IY = Pointer to the string 
   8A9C CD 4D 97      [17]  252 	call cpct_drawStringM0_asm
                            253 
                            254 
   8A9F 11 00 C0      [10]  255 	ld   de, #0xC000 ;; DE = Pointer to start of the screen
   8AA2 06 78         [ 7]  256    	ld    b, #120                  ;; B = y coordinate (24 = 0x18)
   8AA4 0E 07         [ 7]  257 	ld    c, #7                  ;; C = x coordinate (16 = 0x10)
   8AA6 CD 95 99      [17]  258 	call cpct_getScreenPtr_asm	
   8AA9 FD 21 EC 88   [14]  259 	ld   iy, #string_cred_linea2    ;; IY = Pointer to the string 
   8AAD CD 4D 97      [17]  260 	call cpct_drawStringM0_asm
                            261 
   8AB0 C9            [10]  262 	ret
                            263 
   8AB1                     264 man_menu_creditos_update::
                            265 
   8AB1 C9            [10]  266 	ret
                            267 
                            268 
   8AB2                     269 man_menu_restart_init::
                            270 
   8AB2 CD EA 7A      [17]  271 	call sys_eren_init
                            272 
                            273 
                            274 
   8AB5 11 00 C0      [10]  275 	ld   de, #0xC000 ;; DE = Pointer to start of the screen
ASxxxx Assembler V02.00 + NoICE + SDCC mods  (Zilog Z80 / Hitachi HD64180), page 62.
Hexadecimal [16-Bits]



   8AB8 06 28         [ 7]  276    	ld    b, #40                  ;; B = y coordinate (24 = 0x18)
   8ABA 0E 03         [ 7]  277 	ld    c, #3                  ;; C = x coordinate (16 = 0x10)
   8ABC CD 95 99      [17]  278 	call cpct_getScreenPtr_asm	
   8ABF FD 21 1A 89   [14]  279 	ld   iy, #string_restart_normal1   ;; IY = Pointer to the string 
   8AC3 CD 4D 97      [17]  280 	call cpct_drawStringM0_asm
                            281 
                            282 
   8AC6 11 00 C0      [10]  283 	ld   de, #0xC000 ;; DE = Pointer to start of the screen
   8AC9 06 50         [ 7]  284    	ld    b, #80                  ;; B = y coordinate (24 = 0x18)
   8ACB 0E 07         [ 7]  285 	ld    c, #7                  ;; C = x coordinate (16 = 0x10)
   8ACD CD 95 99      [17]  286 	call cpct_getScreenPtr_asm	
   8AD0 FD 21 2D 89   [14]  287 	ld   iy, #string_restart_normal2   ;; IY = Pointer to the string 
   8AD4 CD 4D 97      [17]  288 	call cpct_drawStringM0_asm
                            289 
                            290 
                            291 
   8AD7 C9            [10]  292 	ret
                            293 
   8AD8                     294 man_menu_restart_init_multi_1::
                            295 
   8AD8 CD EA 7A      [17]  296 	call sys_eren_init
                            297 
   8ADB 11 00 C0      [10]  298 	ld   de, #0xC000 ;; DE = Pointer to start of the screen
   8ADE 06 50         [ 7]  299    	ld    b, #80                  ;; B = y coordinate (24 = 0x18)
   8AE0 0E 03         [ 7]  300 	ld    c, #3                  ;; C = x coordinate (16 = 0x10)
   8AE2 CD 95 99      [17]  301 	call cpct_getScreenPtr_asm	
   8AE5 FD 21 1A 89   [14]  302 	ld   iy, #string_restart_normal1   ;; IY = Pointer to the string 
   8AE9 CD 4D 97      [17]  303 	call cpct_drawStringM0_asm
                            304 
                            305 
   8AEC 11 00 C0      [10]  306 	ld   de, #0xC000 ;; DE = Pointer to start of the screen
   8AEF 06 64         [ 7]  307    	ld    b, #100                  ;; B = y coordinate (24 = 0x18)
   8AF1 0E 07         [ 7]  308 	ld    c, #7                  ;; C = x coordinate (16 = 0x10)
   8AF3 CD 95 99      [17]  309 	call cpct_getScreenPtr_asm	
   8AF6 FD 21 2D 89   [14]  310 	ld   iy, #string_restart_normal2   ;; IY = Pointer to the string 
   8AFA CD 4D 97      [17]  311 	call cpct_drawStringM0_asm
                            312 
   8AFD 26 00         [ 7]  313 	ld    h, #0         ;; C= Background PEN ()
   8AFF 2E 05         [ 7]  314 	ld    l, #5         ;; B = Foreground PEN ()
                            315 
   8B01 CD 72 99      [17]  316 	call cpct_setDrawCharM0_asm
                            317 
                            318 
   8B04 11 00 C0      [10]  319 	ld   de, #0xC000 ;; DE = Pointer to start of the screen
   8B07 06 28         [ 7]  320    	ld    b, #40                  ;; B = y coordinate (24 = 0x18)
   8B09 0E 09         [ 7]  321 	ld    c, #9                  ;; C = x coordinate (16 = 0x10)
   8B0B CD 95 99      [17]  322 	call cpct_getScreenPtr_asm	
   8B0E FD 21 0C 89   [14]  323 	ld   iy, #string_restart_2   ;; IY = Pointer to the string 
   8B12 CD 4D 97      [17]  324 	call cpct_drawStringM0_asm
                            325 
   8B15 26 00         [ 7]  326 	ld    h, #0         ;; C= Background PEN ()
   8B17 2E 0F         [ 7]  327 	ld    l, #15         ;; B = Foreground PEN ()
                            328 
   8B19 CD 72 99      [17]  329 	call cpct_setDrawCharM0_asm
                            330 
...
Hexadecimal [16-Bits]
   ...
   8B1C C9            [10]  332 	ret
                            333 
   8B1D                     334 man_menu_restart_init_multi_2::
                            335 
   8B1D CD EA 7A      [17]  336 	call sys_eren_init
                            337 
   8B20 11 00 C0      [10]  338 	ld   de, #0xC000 ;; DE = Pointer to start of the screen
   8B23 06 50         [ 7]  339    	ld    b, #80                  ;; B = y coordinate (24 = 0x18)
   8B25 0E 03         [ 7]  340 	ld    c, #3                  ;; C = x coordinate (16 = 0x10)
   8B27 CD 95 99      [17]  341 	call cpct_getScreenPtr_asm	
   8B2A FD 21 1A 89   [14]  342 	ld   iy, #string_restart_normal1   ;; IY = Pointer to the string 
   8B2E CD 4D 97      [17]  343 	call cpct_drawStringM0_asm
                            344 
                            345 
   8B31 11 00 C0      [10]  346 	ld   de, #0xC000 ;; DE = Pointer to start of the screen
   8B34 06 64         [ 7]  347    	ld    b, #100                  ;; B = y coordinate (24 = 0x18)
   8B36 0E 07         [ 7]  348 	ld    c, #7                  ;; C = x coordinate (16 = 0x10)
   8B38 CD 95 99      [17]  349 	call cpct_getScreenPtr_asm	
   8B3B FD 21 2D 89   [14]  350 	ld   iy, #string_restart_normal2   ;; IY = Pointer to the string 
   8B3F CD 4D 97      [17]  351 	call cpct_drawStringM0_asm
                            352 
   8B42 26 00         [ 7]  353 	ld    h, #0         ;; C= Background PEN ()
   8B44 2E 0E         [ 7]  354 	ld    l, #14         ;; B = Foreground PEN ()
   8B46 CD 72 99      [17]  355 	call cpct_setDrawCharM0_asm
                            356 
   8B49 11 00 C0      [10]  357 	ld   de, #0xC000 ;; DE = Pointer to start of the screen
   8B4C 06 28         [ 7]  358    	ld    b, #40                  ;; B = y coordinate (24 = 0x18)
   8B4E 0E 09         [ 7]  359 	ld    c, #9                  ;; C = x coordinate (16 = 0x10)
   8B50 CD 95 99      [17]  360 	call cpct_getScreenPtr_asm	
   8B53 FD 21 FE 88   [14]  361 	ld   iy, #string_restart_1   ;; IY = Pointer to the string 
   8B57 CD 4D 97      [17]  362 	call cpct_drawStringM0_asm
                            363 
   8B5A 26 00         [ 7]  364 	ld    h, #0         ;; C= Background PEN ()
   8B5C 2E 0F         [ 7]  365 	ld    l, #15         ;; B = Foreground PEN ()
                            366 
   8B5E CD 72 99      [17]  367 	call cpct_setDrawCharM0_asm
                            368 
   8B61 C9            [10]  369 	ret
                            370 
                            371 
                            372 
   8B62                     373 man_menu_restart_update::
                            374 
   8B62 CD 9D 8E      [17]  375 	call cpct_scanKeyboard_f_asm
                            376 
                            377 
   8B65 21 06 20      [10]  378 	ld hl, #Key_F
   8B68 CD 91 8E      [17]  379 	call cpct_isKeyPressed_asm
   8B6B 28 03         [12]  380 	jr z, F_restart_NotPressed
                            381 
   8B6D C3 E0 75      [10]  382 	jp start_game
                            383 
                            384 
   8B70                     385 F_restart_NotPressed::
...
Hexadecimal [16-Bits]
   ...
   8B70 C9            [10]  388 	ret
                            389 
   8B71                     390 man_menu_nivel_update::
                            391 
   8B71 CD 9D 8E      [17]  392 	call cpct_scanKeyboard_f_asm
   8B74 21 08 01      [10]  393    ld hl, #Key_1
   8B77 CD 91 8E      [17]  394    call cpct_isKeyPressed_asm
   8B7A 28 08         [12]  395    jr z, one_NotPressed
   8B7C 3E 01         [ 7]  396    ld a, #1
   8B7E CD 9E 75      [17]  397    call set_level
   8B81 C3 E0 75      [10]  398    jp start_game
   8B84                     399 one_NotPressed:
   8B84 21 08 02      [10]  400    ld hl, #Key_2
   8B87 CD 91 8E      [17]  401    call cpct_isKeyPressed_asm
   8B8A 28 08         [12]  402    jr z, two_NotPressed
   8B8C 3E 02         [ 7]  403    ld a, #2
   8B8E CD 9E 75      [17]  404    call set_level
   8B91 C3 E0 75      [10]  405    jp start_game
   8B94                     406 two_NotPressed:
   8B94 21 07 02      [10]  407    ld hl, #Key_3
   8B97 CD 91 8E      [17]  408    call cpct_isKeyPressed_asm
   8B9A 28 08         [12]  409    jr z, three_NotPressed
   8B9C 3E 03         [ 7]  410    ld a, #3
   8B9E CD 9E 75      [17]  411    call set_level
   8BA1 C3 E0 75      [10]  412    jp start_game
   8BA4                     413 three_NotPressed:
                            414 
                            415 
   8BA4 C9            [10]  416 	ret
                            417 	
   8BA5                     418 man_menu_nivel_init::
                            419 
                            420 
   8BA5 11 00 C0      [10]  421 	ld   de, #0xC000 ;; DE = Pointer to start of the screen
   8BA8 06 50         [ 7]  422    	ld    b, #80                  ;; B = y coordinate (24 = 0x18)
   8BAA 0E 03         [ 7]  423 	ld    c, #3                  ;; C = x coordinate (16 = 0x10)
   8BAC CD 95 99      [17]  424 	call cpct_getScreenPtr_asm	
   8BAF FD 21 1A 89   [14]  425 	ld   iy, #string_restart_normal1   ;; IY = Pointer to the string 
   8BB3 CD 4D 97      [17]  426 	call cpct_drawStringM0_asm
                            427 
                            428 
   8BB6 11 00 C0      [10]  429 	ld   de, #0xC000 ;; DE = Pointer to start of the screen
   8BB9 06 64         [ 7]  430    	ld    b, #100                  ;; B = y coordinate (24 = 0x18)
   8BBB 0E 07         [ 7]  431 	ld    c, #7                  ;; C = x coordinate (16 = 0x10)
   8BBD CD 95 99      [17]  432 	call cpct_getScreenPtr_asm	
   8BC0 FD 21 2D 89   [14]  433 	ld   iy, #string_restart_normal2   ;; IY = Pointer to the string 
   8BC4 CD 4D 97      [17]  434 	call cpct_drawStringM0_asm
                            435 
   8BC7 11 00 C0      [10]  436 	ld   de, #0xC000 ;; DE = Pointer to start of the screen
   8BCA 06 28         [ 7]  437    	ld    b, #40                  ;; B = y coordinate (24 = 0x18)
   8BCC 0E 09         [ 7]  438 	ld    c, #9                  ;; C = x coordinate (16 = 0x10)
   8BCE CD 95 99      [17]  439 	call cpct_getScreenPtr_asm	
   8BD1 FD 21 3C 89   [14]  440 	ld   iy, #string_elige_nivel   ;; IY = Pointer to the string 
ASxxxx Assembler V02.00 + NoICE + SDCC mods  (Zilog Z80 / Hitachi HD64180), page 65.
Hexadecimal [16-Bits]



   8BD5 CD 4D 97      [17]  441 	call cpct_drawStringM0_asm
                            442 
                            443 
   8BD8 11 00 C0      [10]  444 	ld   de, #0xC000 ;; DE = Pointer to start of the screen
   8BDB 06 3C         [ 7]  445    	ld    b, #60                  ;; B = y coordinate (24 = 0x18)
   8BDD 0E 09         [ 7]  446 	ld    c, #9                  ;; C = x coordinate (16 = 0x10)
   8BDF CD 95 99      [17]  447 	call cpct_getScreenPtr_asm	
   8BE2 FD 21 4C 89   [14]  448 	ld   iy, #string_elige_nivel2   ;; IY = Pointer to the string 
   8BE6 CD 4D 97      [17]  449 	call cpct_drawStringM0_asm
                            450 
                            451 
   8BE9 CD 72 99      [17]  452 	call cpct_setDrawCharM0_asm
                            453 
   8BEC C9            [10]  454 	ret
