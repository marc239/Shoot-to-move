...
Hexadecimal [16-Bits]
                             ...
                             20 .include "sys/sys_physics.h.s"
...
Hexadecimal [16-Bits]
                             ...
                             23 .include "sys/sys_ai_control.h.s"
...
Hexadecimal [16-Bits]
                             ...
                             29 .include "sys/sys_collision.h.s"
...
Hexadecimal [16-Bits]
                             ...
                             31 
                             32 
                             33 ;:;;;;;;;;;;;;;;;INPUT SYSTEM FOR SECOND PLAYER
                             34 
                             35 .globl Key_CursorRight
                             36 .globl Key_CursorLeft
                             37 .globl Key_CursorDown
                             38 
   8814                      39 _ya_eliminado:
   8814 00                   40 	.db 0x00
                             41 
   8815 00                   42 _s_pulsada: .db 0x00
   8816 00                   43 _a_pulsada: .db 0x00
   8817 00                   44 _d_pulsada: .db 0x00
                             45 
   8818                      46 man_multiplayer_input_update::
                             47 
   8818 DD 36 02 00   [19]   48 	ld e_vx(ix), #0
                             49 	;ld e_vy(ix), #0 ;;RESETEAMOS VELOCIDADES
   881C DD E5         [15]   50 	push ix
   881E CD 9D 8E      [17]   51 	call cpct_scanKeyboard_f_asm
                             52 ;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
                             53 ;; PULSAR LA D
   8821 21 00 02      [10]   54 	ld hl, #Key_CursorRight
   8824 CD 91 8E      [17]   55 	call cpct_isKeyPressed_asm
   8827 28 1F         [12]   56 	jr z, D_NotPressed
   8829                      57 D_Pressed:
   8829 3A 17 88      [13]   58 	ld a, (_d_pulsada)
   882C FE 00         [ 7]   59 	cp #0
   882E 20 1D         [12]   60 	jr nz, D_ya_pulsada
                             61 	;;AQUI LO QUE HACEMOS AL PULSAR LA A
   8830 DD 36 02 FC   [19]   62 	ld e_vx(ix), #-4 ;;Ponemos velocidad
                             63 
   8834 DD 56 00      [19]   64 	ld d, e_x(ix)
   8837 DD 5E 01      [19]   65 	ld e, e_y(ix)
   883A 0E 00         [ 7]   66 	ld c, #0
   883C 06 02         [ 7]   67 	ld b, #2
   883E CD 3C 8E      [17]   68 	call man_entity_crearBala
                             69 	;;AHORA CREAMOS UNA BALA
                             70 	
                             71 	
   8841 3E 01         [ 7]   72 	ld a, #1
   8843 32 17 88      [13]   73 	ld (_d_pulsada), a
   8846 18 5D         [12]   74 	jr ya_pulsado
                             75 
   8848                      76 D_NotPressed:
   8848 3E 00         [ 7]   77 	ld a, #0
   884A 32 17 88      [13]   78 	ld (_d_pulsada), a
                             79 
   884D                      80 D_ya_pulsada:
                             81 ;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
                             82 ;;PULSAR LA A
                             83 ;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
   884D 21 01 01      [10]   84 	ld hl, #Key_CursorLeft
ASxxxx Assembler V02.00 + NoICE + SDCC mods  (Zilog Z80 / Hitachi HD64180), page 67.
Hexadecimal [16-Bits]



   8850 CD 91 8E      [17]   85 	call cpct_isKeyPressed_asm
   8853 28 1F         [12]   86 	jr z, A_NotPressed
   8855                      87 A_Pressed:
   8855 3A 16 88      [13]   88 	ld a, (_a_pulsada)
   8858 FE 00         [ 7]   89 	cp #0
   885A 20 1D         [12]   90 	jr nz, A_ya_pulsada
                             91 	;;AQUI LO QUE HACEMOS AL PULSAR LA A
   885C DD 36 02 04   [19]   92 	ld e_vx(ix), #4 ;;Ponemos velocidad
                             93 
   8860 DD 56 00      [19]   94 	ld d, e_x(ix)
   8863 DD 5E 01      [19]   95 	ld e, e_y(ix)
   8866 06 01         [ 7]   96 	ld b, #1
   8868 0E 00         [ 7]   97 	ld c, #0
   886A CD 3C 8E      [17]   98 	call man_entity_crearBala
                             99 	;;AHORA CREAMOS UNA BALA
                            100 	
                            101 	
   886D 3E 01         [ 7]  102 	ld a, #1
   886F 32 16 88      [13]  103 	ld (_a_pulsada), a
   8872 18 31         [12]  104 	jr ya_pulsado
                            105 
   8874                     106 A_NotPressed:
   8874 3E 00         [ 7]  107 	ld a, #0
   8876 32 16 88      [13]  108 	ld (_a_pulsada), a
                            109 
   8879                     110 A_ya_pulsada:
                            111 
   8879 21 00 04      [10]  112 	ld hl, #Key_CursorDown
   887C CD 91 8E      [17]  113 	call cpct_isKeyPressed_asm
   887F 28 1F         [12]  114 	jr z, S_NotPressed
   8881                     115 S_Pressed:
   8881 3A 15 88      [13]  116 	ld a, (_s_pulsada)
   8884 FE 00         [ 7]  117 	cp #0
   8886 20 1D         [12]  118 	jr nz, S_ya_pulsada
                            119 	;;AQUI LO QUE HACEMOS AL PULSAR LA S
   8888 DD 36 03 F8   [19]  120 	ld e_vy(ix), #-8 ;;Ponemos velocidad
                            121 
   888C DD 56 00      [19]  122 	ld d, e_x(ix)
   888F DD 5E 01      [19]  123 	ld e, e_y(ix)
   8892 06 03         [ 7]  124 	ld b, #3
   8894 0E 00         [ 7]  125 	ld c, #0
   8896 CD 3C 8E      [17]  126 	call man_entity_crearBala
                            127 	;;AHORA CREAMOS UNA BALA
                            128 	
                            129 	
   8899 3E 01         [ 7]  130 	ld a, #1
   889B 32 15 88      [13]  131 	ld (_s_pulsada), a
   889E 18 05         [12]  132 	jr ya_pulsado
                            133 
   88A0                     134 S_NotPressed:
   88A0 3E 00         [ 7]  135 	ld a, #0
   88A2 32 15 88      [13]  136 	ld (_s_pulsada), a
                            137 
   88A5                     138 S_ya_pulsada:
                            139 
...
Hexadecimal [16-Bits]
   ...
   88A5                     141 ya_pulsado:
                            142 
   88A5 DD E1         [14]  143 	pop ix
   88A7 CD 17 7C      [17]  144 	call sys_dash_update
                            145 	;ld a, e_vx(ix)
                            146 	;sub #0
                            147 
                            148 
