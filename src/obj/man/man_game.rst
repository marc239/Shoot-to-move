...
Hexadecimal [16-Bits]
                             ...
                             24 .include "sys/sys_ai_control.h.s"
                              1 .globl sys_ai_control_update
                              2 .globl sys_ai_control_init
ASxxxx Assembler V02.00 + NoICE + SDCC mods  (Zilog Z80 / Hitachi HD64180), page 59.
Hexadecimal [16-Bits]



                             25 .include "sys/sys_collision.h.s"
...
Hexadecimal [16-Bits]
                             ...
                             26 .include "sys/sys_dash.h.s"
                              1 .globl sys_dash_update
ASxxxx Assembler V02.00 + NoICE + SDCC mods  (Zilog Z80 / Hitachi HD64180), page 61.
Hexadecimal [16-Bits]



                             27 .include "sys/sys_death.h.s"
                              1 .globl sys_death_update
                              2 .globl sys_death_update_multi
ASxxxx Assembler V02.00 + NoICE + SDCC mods  (Zilog Z80 / Hitachi HD64180), page 62.
Hexadecimal [16-Bits]



                             28 .include "man/man_entity.h.s"
...
Hexadecimal [16-Bits]
                             ...
                             30 .include "man/man_multiplayer.h.s"
...
Hexadecimal [16-Bits]
                             ...
                             32 
                             33 .module game_manager
                             34 
   0000                      35 ent1: DefineCmp_Entity 70, 0, 0, 0, 4, 16, _sp_mainchar, e_ai_st_noAI, 0, 0, 0, 1, 0
   7F1D 46 00                 1 	.db 70, 0
   7F1F 00 00                 2 	.db 0, 0
   7F21 04 10                 3 	.db 4, 16
   7F23 54 75                 4 	.dw _sp_mainchar
   7F25 00                    5 	.db 0x00 ;;COMPRUEBA SI ES LA PRIMERA VEZ QUE SE DIBUJA
   7F26 00                    6 	.db 0 ;;COLISION 0 -> no colisiona 1-> si colisiona 2-> bala/enemigo
   7F27 00                    7 	.db 0
   7F28 00                    8 	.db 0 ;;entidades con salud = 0-> entidades que no sufren dmg
                              9 	;;en el caso de las entidades que hacen dmg, health es el dmg que causan
   7F29 00 00                10 	.db 0x00, 0x00 ;;AI-aim x,y(hacia donde va)
   7F2B 00                   11 	.db e_ai_st_noAI 		;;AI - Status
   7F2C 00                   12 	.db e_ai_st_noAI
   7F2D 00                   13 	.db 0x00
   7F2E 01                   14 	.db 1 ;;0->  es mapa 1-> NO es mapa 
   7F2F 00                   15 	.db 0
   7F30 00 00                16 	.dw 0x0000			;; AI puntero a patrulla step
   7F32 CC CC                17 	.dw 0xCCCC;;puntero a la ultima posicion de la memoria de video
                             18 			;;sirve para borrar mas deprisa (asi se calcula solo una vez)
   0017                      36 ent2: DefineCmp_Entity 40, 100, 0, 0, 4, 8, _sp_redball,  e_ai_st_stand_by, 1, 0, 1, 1, 0
   7F34 28 64                 1 	.db 40, 100
   7F36 00 00                 2 	.db 0, 0
   7F38 04 08                 3 	.db 4, 8
   7F3A 84 74                 4 	.dw _sp_redball
   7F3C 00                    5 	.db 0x00 ;;COMPRUEBA SI ES LA PRIMERA VEZ QUE SE DIBUJA
   7F3D 01                    6 	.db 1 ;;COLISION 0 -> no colisiona 1-> si colisiona 2-> bala/enemigo
   7F3E 00                    7 	.db 0
   7F3F 01                    8 	.db 1 ;;entidades con salud = 0-> entidades que no sufren dmg
                              9 	;;en el caso de las entidades que hacen dmg, health es el dmg que causan
   7F40 00 00                10 	.db 0x00, 0x00 ;;AI-aim x,y(hacia donde va)
   7F42 01                   11 	.db e_ai_st_stand_by 		;;AI - Status
   7F43 01                   12 	.db e_ai_st_stand_by
   7F44 00                   13 	.db 0x00
   7F45 01                   14 	.db 1 ;;0->  es mapa 1-> NO es mapa 
   7F46 00                   15 	.db 0
   7F47 00 00                16 	.dw 0x0000			;; AI puntero a patrulla step
   7F49 CC CC                17 	.dw 0xCCCC;;puntero a la ultima posicion de la memoria de video
                             18 			;;sirve para borrar mas deprisa (asi se calcula solo una vez)
   002E                      37 ent4: DefineCmp_Entity 0, 100, 0, 0, 15, 8, _sp_plat, e_ai_st_noAI, 1, 0, 0, 0, 0
   7F4B 00 64                 1 	.db 0, 100
   7F4D 00 00                 2 	.db 0, 0
   7F4F 0F 08                 3 	.db 15, 8
   7F51 B4 73                 4 	.dw _sp_plat
   7F53 00                    5 	.db 0x00 ;;COMPRUEBA SI ES LA PRIMERA VEZ QUE SE DIBUJA
   7F54 01                    6 	.db 1 ;;COLISION 0 -> no colisiona 1-> si colisiona 2-> bala/enemigo
   7F55 00                    7 	.db 0
   7F56 00                    8 	.db 0 ;;entidades con salud = 0-> entidades que no sufren dmg
                              9 	;;en el caso de las entidades que hacen dmg, health es el dmg que causan
   7F57 00 00                10 	.db 0x00, 0x00 ;;AI-aim x,y(hacia donde va)
   7F59 00                   11 	.db e_ai_st_noAI 		;;AI - Status
   7F5A 00                   12 	.db e_ai_st_noAI
   7F5B 00                   13 	.db 0x00
...
Hexadecimal [16-Bits]
   ...
   7F5C 00                   14 	.db 0 ;;0->  es mapa 1-> NO es mapa 
   7F5D 00                   15 	.db 0
   7F5E 00 00                16 	.dw 0x0000			;; AI puntero a patrulla step
   7F60 CC CC                17 	.dw 0xCCCC;;puntero a la ultima posicion de la memoria de video
                             18 			;;sirve para borrar mas deprisa (asi se calcula solo una vez)
                             38 
                             39 
                             40 
                             41 
                             42 
   7F62                      43 man_game_render::
                             44 
                             45 	;cpctm_setBorder_asm HW_RED ;;ESTO nos permite probar cuanto tardamos en renderizar
                             46 
   7F62 CD D3 8D      [17]   47 	call man_entity_getArray
   7F65 CD 06 7B      [17]   48 	call sys_eren_update
                             49 
                             50 	;cpctm_setBorder_asm HW_WHITE
                             51 
                             52 
   7F68 C9            [10]   53 	ret
                             54 
   7F69                      55 man_game_init::
                             56 
   7F69 CD DB 8D      [17]   57 	call man_entity_init		;; HL = Entity array
   7F6C CD 09 80      [17]   58 	call man_patrol_init
                             59 
                             60 	;;INICIA SISTEMAS
   7F6F CD D3 8D      [17]   61 	call man_entity_getArray
   7F72 CD A0 76      [17]   62 	call sys_ai_control_init
   7F75 CD BC 7B      [17]   63 	call sys_physics_init
   7F78 CD D3 8D      [17]   64 	call man_entity_getArray
                             65 
   7F7B CD 4B 7A      [17]   66 	call sys_input_init
   7F7E CD D3 8D      [17]   67 	call man_entity_getArray
   7F81 CD EA 7A      [17]   68 	call sys_eren_init
                             69 
   7F84 C9            [10]   70 	ret
                             71 
                             72 
                             ...
                             74 
                             75 
   7F85                      76 man_game_update::
                             77 	
   7F85 CD D3 8D      [17]   78 	call man_entity_getArray
   7F88 CD 4F 7A      [17]   79 	call sys_input_update
                             80 
   7F8B CD D3 8D      [17]   81 	call man_entity_getArray
   7F8E CD 54 77      [17]   82 	call sys_ai_control_update
                             83 
   7F91 CD D3 8D      [17]   84 	call man_entity_getArray
   7F94 CD D9 77      [17]   85 	call sys_collision_update_hero
   7F97 CD D3 8D      [17]   86 	call man_entity_getArray
   7F9A CD D0 78      [17]   87 	call sys_collision_update_dmg
...
Hexadecimal [16-Bits]
                             ...
                             88 
   7F9D CD D3 8D      [17]   89 	call man_entity_getArray
   7FA0 CD BD 7B      [17]   90 	call sys_physics_update
                             91 
   7FA3 CD D3 8D      [17]   92 	call man_entity_getArray
   7FA6 CD AD 77      [17]   93 	call sys_death_update
                             94 
                             95 
   7FA9 C9            [10]   96 	ret
                             97 
                             98 
                             99 
   7FAA                     100 man_game_update_multi::
                            101 	
   7FAA CD D3 8D      [17]  102 	call man_entity_getArray
   7FAD CD 4F 7A      [17]  103 	call sys_input_update
                            104 
   7FB0 CD D3 8D      [17]  105 	call man_entity_getArray
   7FB3 01 17 00      [10]  106 	ld bc, #sizeof_e
   7FB6 DD 09         [15]  107 	add ix, bc ;;pasamos a la segunda entidad
   7FB8 CD 18 88      [17]  108 	call man_multiplayer_input_update
                            109 
   7FBB CD D3 8D      [17]  110 	call man_entity_getArray
   7FBE CD 54 77      [17]  111 	call sys_ai_control_update
                            112 
   7FC1 CD D3 8D      [17]  113 	call man_entity_getArray
   7FC4 CD D9 77      [17]  114 	call sys_collision_update_hero
                            115 
   7FC7 CD D3 8D      [17]  116 	call man_entity_getArray
   7FCA 01 17 00      [10]  117 	ld bc, #sizeof_e
   7FCD DD 09         [15]  118 	add ix, bc ;;pasamos a la segunda entidad
   7FCF 3D            [ 4]  119 	dec a
   7FD0 CD 9C 79      [17]  120 	call sys_collision_update_hero2
                            121 
   7FD3 CD D3 8D      [17]  122 	call man_entity_getArray
   7FD6 CD D0 78      [17]  123 	call sys_collision_update_dmg
                            124 
   7FD9 CD D3 8D      [17]  125 	call man_entity_getArray
   7FDC CD BD 7B      [17]  126 	call sys_physics_update
                            127 
   7FDF CD D3 8D      [17]  128 	call man_entity_getArray
   7FE2 CD BA 77      [17]  129 	call sys_death_update_multi
                            130 
                            131 
   7FE5 C9            [10]  132 	ret
