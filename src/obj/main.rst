...
Hexadecimal [16-Bits]
                              ...
                              3 ;;
                              4 ;;     SHOOT TO MOVEis free software: you can redistribute it and/or modify
                             ...
                             16 
                             17 ;; Include all CPCtelera constant definitions, macros and variables
...
Hexadecimal [16-Bits]
                             ...
                             21 .include "man/man_one_levels.h.s"
...
Hexadecimal [16-Bits]
                             ...
                             22 .include "man/man_multi_levels.h.s"
                              1 .globl man_level1_multi_init
                              2 .globl man_level2_multi_init
                              3 .globl man_level3_multi_init
ASxxxx Assembler V02.00 + NoICE + SDCC mods  (Zilog Z80 / Hitachi HD64180), page 57.
Hexadecimal [16-Bits]



                             23 .include "man/man_menu.h.s"
                              1 .globl man_menu_inicial_init
                              2 .globl man_menu_inicial_update
                              3 .globl man_menu_creditos_update
                              4 .globl man_menu_creditos_init
                              5 .globl man_menu_restart_init
                              6 .globl man_menu_restart_update
                              7 .globl man_menu_restart_init_multi_1
                              8 .globl man_menu_restart_init_multi_2
                              9 .globl man_menu_nivel_update
                             10 .globl man_menu_nivel_init
                             11 
                             12 .globl string_titulo
                             13 .globl string_start
                             14 .globl string_multi
                             15 .globl string_arcade
                             16 .globl string_creditos
                             17 .globl string_cred_linea1
                             18 .globl string_cred_linea2
ASxxxx Assembler V02.00 + NoICE + SDCC mods  (Zilog Z80 / Hitachi HD64180), page 58.
Hexadecimal [16-Bits]



                             24 .include "man/man_multiplayer.h.s"
                              1 .globl man_multiplayer_input_update
ASxxxx Assembler V02.00 + NoICE + SDCC mods  (Zilog Z80 / Hitachi HD64180), page 59.
Hexadecimal [16-Bits]



                             25 .include "man/man_escape.h.s"
                              1 .globl man_escape_update
ASxxxx Assembler V02.00 + NoICE + SDCC mods  (Zilog Z80 / Hitachi HD64180), page 60.
Hexadecimal [16-Bits]



                             26 .include "sys/sys_render.h.s"
...
Hexadecimal [16-Bits]
                             ...
                             32 .area _CODE
                             33 
   7594 01                   34 _level: .db 0x01
   7595 01                   35 _mode: .db 0x01 ;;1-> individual 2-> multiplayer
                             36 
                             37 
   7596                      38 inc_level::
   7596 3A 94 75      [13]   39    ld a, (_level)
   7599 3C            [ 4]   40    inc a
   759A 32 94 75      [13]   41    ld (_level),a
   759D C9            [10]   42    ret
                             43 ;;input a->level
   759E                      44 set_level::
   759E 32 94 75      [13]   45    ld (_level),a
   75A1 C9            [10]   46    ret
                             47 
   75A2                      48 set_multiplayer::
                             49 
   75A2 3E 02         [ 7]   50    ld a, #2
   75A4 32 95 75      [13]   51    ld (_mode), a
                             52 
   75A7 C9            [10]   53    ret
                             54 
   75A8                      55 set_individual::
                             56 
   75A8 3E 01         [ 7]   57    ld a, #1
   75AA 32 95 75      [13]   58    ld (_mode), a
                             59 
   75AD C9            [10]   60    ret
                             61 ;;
                             62 ;; MAIN function. This is the entry point of the application.
                             63 ;;    _main:: global symbol is required for correctly compiling and linking
                             64 ;;
   75AE                      65 _main::
                             66    ;; Disable firmware to prevent it from interfering with string drawing
   75AE CD 96 98      [17]   67    call cpct_disableFirmware_asm
   75B1 F1            [10]   68       pop af
   001E                      69       cpctm_setBorder_asm HW_WHITE
                              1    .radix h
   001E                       2    cpctm_setBorder_raw_asm \HW_WHITE ;; [28] Macro that does the job, but requires a number value to be passed
                              1    .globl cpct_setPALColour_asm
   75B2 21 10 00      [10]    2    ld   hl, #0x010         ;; [3]  H=Hardware value of desired colour, L=Border INK (16)
   75B5 CD 1A 8F      [17]    3    call cpct_setPALColour_asm  ;; [25] Set Palette colour of the border
                              3    .radix d
                             70    ;;MUESTRA EL MENU PRINCIPAL
   75B8 CD EA 7A      [17]   71    call sys_eren_init
   75BB CD 61 89      [17]   72    call man_menu_inicial_init
   75BE CD 89 96      [17]   73    call cpct_akp_stop_asm
                             74 
                             75 
...
Hexadecimal [16-Bits]
                             ...
                             76 
   75C1 3E 01         [ 7]   77    ld a, #1
   75C3 32 94 75      [13]   78    ld (_level), a
   75C6 32 95 75      [13]   79    ld (_mode), a
                             80 
   75C9                      81 loopMenu:
   75C9 CD 81 98      [17]   82    call cpct_waitVSYNC_asm	
   75CC CD BB 89      [17]   83    call man_menu_inicial_update
                             84 
   75CF 18 F8         [12]   85    jr    loopMenu
                             86 
   75D1                      87 startCreditos::
   75D1 F1            [10]   88 	pop af
   75D2 CD 71 8A      [17]   89 	call man_menu_creditos_init
   75D5                      90 loopCreditos:
                             91    ;;
   75D5 CD 81 98      [17]   92    call cpct_waitVSYNC_asm	
   75D8 CD B1 8A      [17]   93    call man_menu_creditos_update
   75DB CD 84 8E      [17]   94    call man_escape_update
   75DE 18 F5         [12]   95    jr    loopCreditos
                             96 
   75E0                      97 start_game::
   75E0 F1            [10]   98 	pop af
                             99    ;; Inicializa el manager de juego
                            100       ;;MUSICA PRUEBAS
   75E1 11 40 00      [10]  101    ld de, #_song_principal
   75E4 CD 30 96      [17]  102    call cpct_akp_musicInit_asm
                            103 
                            104 
   75E7 CD 69 7F      [17]  105    call man_game_init
                            106 
                            107 ;;comprobamos si es multiplayer
   75EA 3A 95 75      [13]  108    ld a, (_mode)
   75ED FE 01         [ 7]  109    cp #01
   75EF 20 3C         [12]  110    jr nz, niveles_multiplayer 
                            111 
   75F1 3A 94 75      [13]  112    ld a, (_level)
   75F4 FE 01         [ 7]  113    cp #01
   75F6 20 03         [12]  114    jr nz, _no_level1
   75F8 CD 66 80      [17]  115    call man_level1_init
   75FB                     116 _no_level1:
   75FB FE 02         [ 7]  117    cp #02
   75FD 20 03         [12]  118    jr nz, _no_level2
   75FF CD 96 81      [17]  119    call man_level2_init
   7602                     120 _no_level2:
   7602 FE 03         [ 7]  121    cp #03
   7604 20 03         [12]  122    jr nz, _no_level3
   7606 CD C8 82      [17]  123    call man_level3_init
   7609                     124 _no_level3:
   7609 FE 04         [ 7]  125    cp #04
   760B 20 03         [12]  126    jr nz, _no_level4
   760D CD EE 83      [17]  127    call man_level4_init
   7610                     128 _no_level4:
   7610 FE 05         [ 7]  129    cp #05
   7612 20 03         [12]  130    jr nz, _no_level5
ASxxxx Assembler V02.00 + NoICE + SDCC mods  (Zilog Z80 / Hitachi HD64180), page 63.
Hexadecimal [16-Bits]



   7614 CD 2B 85      [17]  131    call man_level5_init
   7617                     132 _no_level5:
   7617 FE 06         [ 7]  133    cp #06
   7619 20 03         [12]  134    jr nz, _no_level6
   761B CD 6E 86      [17]  135    call man_level6_init
   761E                     136 _no_level6:
   761E FE 07         [ 7]  137    cp #07
   7620 20 03         [12]  138    jr nz, _no_level7
   7622 CD C8 87      [17]  139    call man_level7_init
   7625                     140 _no_level7:
   7625 FE 08         [ 7]  141    cp #08
   7627 20 02         [12]  142    jr nz, _no_final
   7629 18 83         [12]  143    jr _main
   762B                     144 _no_final:
   762B 18 24         [12]  145    jr loop
                            146 
   762D                     147 niveles_multiplayer:
                            148 
   762D 3A 94 75      [13]  149    ld a, (_level)
   7630 FE 01         [ 7]  150    cp #01
   7632 20 05         [12]  151    jr nz , no_level1
   7634 CD 98 7C      [17]  152    call man_level1_multi_init
   7637 18 29         [12]  153    jr loopmulti
   7639                     154 no_level1:
   7639 3A 94 75      [13]  155    ld a, (_level)
   763C FE 02         [ 7]  156    cp #02
   763E 20 05         [12]  157    jr nz , no_level2
   7640 CD 6C 7D      [17]  158    call man_level2_multi_init
   7643 18 1D         [12]  159    jr loopmulti
   7645                     160 no_level2:
   7645 3A 94 75      [13]  161    ld a, (_level)
   7648 FE 03         [ 7]  162    cp #03
   764A 20 05         [12]  163    jr nz , no_level3
   764C CD CB 7E      [17]  164    call man_level3_multi_init
   764F 18 11         [12]  165    jr loopmulti
   7651                     166 no_level3:
                            167 
                            168 
                            169 
   ...
   7651                     173 loop:
                            174 
   7651 CD 85 7F      [17]  175    call man_game_update
   7654 CD 81 98      [17]  176    call cpct_waitVSYNC_asm
   7657 CD 62 7F      [17]  177    call man_game_render
   765A CD 26 8F      [17]  178    call cpct_akp_musicPlay_asm
   765D CD 84 8E      [17]  179    call man_escape_update
   7660 18 EF         [12]  180    jr    loop
                            181 
   7662                     182 loopmulti:
                            183 
   7662 CD AA 7F      [17]  184    call man_game_update_multi
   7665 CD 81 98      [17]  185    call cpct_waitVSYNC_asm
ASxxxx Assembler V02.00 + NoICE + SDCC mods  (Zilog Z80 / Hitachi HD64180), page 64.
Hexadecimal [16-Bits]



   7668 CD 62 7F      [17]  186    call man_game_render
   766B CD 26 8F      [17]  187    call cpct_akp_musicPlay_asm
   766E CD 84 8E      [17]  188    call man_escape_update
   7671 18 EF         [12]  189    jr    loopmulti
                            190 
   7673                     191 menu_nivel_multi::
   7673 CD EA 7A      [17]  192       call sys_eren_init
   7676 CD A5 8B      [17]  193       call man_menu_nivel_init
   7679                     194 loop_nivel_multi:
                            195 
   7679 CD 71 8B      [17]  196    call man_menu_nivel_update
                            197 
   767C 18 FB         [12]  198    jr loop_nivel_multi
                            199 
   767E                     200 menu_restart::
   767E F1            [10]  201    pop af
                            202 
   767F 78            [ 4]  203    ld a, b
   7680 FE 01         [ 7]  204    cp #1
   7682 20 05         [12]  205    jr nz, no1
   7684 CD D8 8A      [17]  206    call man_menu_restart_init_multi_1
   7687 18 0C         [12]  207    jr ya_init_restart
   7689                     208 no1:
   7689 FE 02         [ 7]  209    cp #2
   768B 20 05         [12]  210    jr nz, no2
   768D CD 1D 8B      [17]  211    call man_menu_restart_init_multi_2
   7690 18 03         [12]  212    jr ya_init_restart
   7692                     213 no2:
   7692 CD B2 8A      [17]  214    call man_menu_restart_init
   7695                     215 ya_init_restart:
                            216 
   7695 CD 89 96      [17]  217    call cpct_akp_stop_asm
                            218 
   7698                     219 loop_restart:
                            220 
   7698 CD 62 8B      [17]  221    call man_menu_restart_update
   769B CD 84 8E      [17]  222    call man_escape_update
   769E 18 F8         [12]  223    jr loop_restart
